...
/**
 * GroupsOpportunity Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupsOpportunity implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'groups-opportunity';
    ...
    protected static $swaggerFormats = [
        'score' => null,
        'additional_monthly_sessions' => 'int32',
        'difficulty' => null,
        'avg_cpc' => 'double'
    ];
    ...
    protected static $setters = [
        'score' => 'setScore',
        'additional_monthly_sessions' => 'setAdditionalMonthlySessions',
    ...
    protected static $getters = [
        'score' => 'getScore',
        'additional_monthly_sessions' => 'getAdditionalMonthlySessions',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['additional_monthly_sessions'] = isset($data['additional_monthly_sessions']) ? $data['additional_monthly_sessions'] : null;
     ...
     * Sets score
     *
     * @param float $score The Opportunity score from 0 to 10.  For the keywords where the Opportunity score is not computed, the value returned will be \"N/A\".
     *
     * @return $this
     */
    ...
    /**
     * Gets additional_monthly_sessions
     *
     * @return int
     */
    public function getAdditionalMonthlySessions()
    {
        return $this->container['additional_monthly_sessions'];
    }

    /**
     * Sets additional_monthly_sessions
     *
     * @param int $additional_monthly_sessions The potential additional monthly sessions if the keywords rank in top 3 on average.
     *
     * @return $this
     */
    public function setAdditionalMonthlySessions($additional_monthly_sessions)
    {
        $this->container['additional_monthly_sessions'] = $additional_monthly_sessions;
     ...
     * Sets difficulty
     *
     * @param string $difficulty The Difficulty level of the keyword to rank in Top 10. Possible values are `already_top_10`, `easy`, `medium`, or `hard`.
     *
     * @return $this
     */
     ...
     * Sets avg_cpc
     *
     * @param double $avg_cpc The average cost per click.
     *
     * @return $this
     */
