...
class Group implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'type' => 'string',
        'subgroups' => '\Swagger\Client\Model\Group[]'
    ];
     ...
     * Sets group_id
     *
     * @param int $group_id The unique identifier for the keyword group. It can be used to reference the group in other endpoints.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Indicates the type of group - either a regular group, a folder for organizing groups, or smart group based on rules.   Possible values are `group`, `folder`, or `smart_group`.
     *
     * @return $this
     */
     ...
     * Sets subgroups
     *
     * @param \Swagger\Client\Model\Group[] $subgroups Parent field containing subgroup objects if the group type is `folder`.
     *
     * @return $this
     */
