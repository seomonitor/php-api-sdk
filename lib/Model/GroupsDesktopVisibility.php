...
/**
 * GroupsDesktopVisibility Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupsDesktopVisibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'groups-desktop-visibility';
     ...
     * Sets latest
     *
     * @param double $latest The overall desktop Visibility at the end of the specified timeframe.
     *
     * @return $this
     */
     ...
     * Sets trend
     *
     * @param double $trend Percentage change in desktop Visibility of the website for all the keywords in the group over the given timeframe.
     *
     * @return $this
     */
