...
/**
 * KeywordSerpFeature Class Doc Comment
 *
 * @category Class
 * @description Details about a SERP feature present in the google search and your presence inside tthat SERP feature.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordSerpFeature implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keyword-serp-feature';
     ...
     * Sets position
     *
     * @param  $position The position of the feature on the Google results page. It can be a number from 1 to 100 or \"side\" if the element is on the right-side panel (e.g., Knowledge Graph on desktop searches).
     *
     * @return $this
     */
     ...
     * Sets listed
     *
     * @param bool $listed Whether your website is listed or not in the SERP feature.
     *
     * @return $this
     */
