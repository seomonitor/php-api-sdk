...
/**
 * CampaignInfo Class Doc Comment
 *
 * @category Class
 * @description The campaign&#x27;s general information such as id, url etc. You can later use the id to retrive data for the groups, keywords etc for a specific campaign.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CampaignInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'campaign-info';
    ...
    protected static $setters = [
        ...
        'keywords_count' => 'setKeywordsCount',
        'campaign_currency' => 'setCampaignCurrency',
        'analytics_currency' => 'setAnalyticsCurrency',
        'domain' => 'setDomain',
    ...
    protected static $getters = [
        ...
        'keywords_count' => 'getKeywordsCount',
        'campaign_currency' => 'getCampaignCurrency',
        'analytics_currency' => 'getAnalyticsCurrency',
        'domain' => 'getDomain',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['keywords_count'] = isset($data['keywords_count']) ? $data['keywords_count'] : null;
        $this->container['campaign_currency'] = isset($data['campaign_currency']) ? $data['campaign_currency'] : null;
        $this->container['analytics_currency'] = isset($data['analytics_currency']) ? $data['analytics_currency'] : null;
     ...
     * Sets company
     *
     * @param string $company The name of the company which owns the campaign
     *
     * @return $this
     */
     ...
     * Sets company_id
     *
     * @param int $company_id The ID of the company that owns the campaign
     *
     * @return $this
     */
     ...
     * Sets date_created
     *
     * @param \DateTime $date_created The date when the campaign was created, in YYYY-MM-DD format.
     *
     * @return $this
     */
    ...
    {
        return $this->container['keywords_count'];
    }

    /**
     * Sets keywords_count
     *
     * @param int $keywords_count The number of active keywords in the campaign.
     *
     * @return $this
     */
    public function setKeywordsCount($keywords_count)
    {
        $this->container['keywords_count'] = $keywords_count;

        return $this;
    }

    /**
     * Gets campaign_currency
     *
     * @return string
     */
    public function getCampaignCurrency()
    {
        return $this->container['campaign_currency'];
    }

    /**
     * Sets campaign_currency
     *
     * @param string $campaign_currency The campaign currency as configured in the campaign setup.
     *
     * @return $this
     */
    public function setCampaignCurrency($campaign_currency)
    {
        $this->container['campaign_currency'] = $campaign_currency;

        return $this;
    }

    /**
     * Gets analytics_currency
     *
     * @return string
     */
    public function getAnalyticsCurrency()
    {
        return $this->container['analytics_currency'];
    }

    /**
     * Sets analytics_currency
     *
     * @param string $analytics_currency The currency pulled from the Google Analytics connection.
     *
     * @return $this
     */
    public function setAnalyticsCurrency($analytics_currency)
    {
        $this->container['analytics_currency'] = $analytics_currency;
     ...
     * Sets domain
     *
     * @param string $domain The domain name of the website being tracked in the campaign.
     *
     * @return $this
     */
     ...
     * Sets location
     *
     * @param string $location The location of the campaign as configured in the campaign setup.
     *
     * @return $this
     */
     ...
     * Sets mrr
     *
     * @param int $mrr The value of the monthly recurring revenue (MRR) as configured in the platform.
     *
     * @return $this
     */
