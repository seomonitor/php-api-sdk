 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TopResults implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'top-results';
    ...
    protected static $swaggerTypes = [
        'keyword_id' => 'int',
        'keyword' => 'string',
        'top_100_results' => '\Swagger\Client\Model\Top100Results[]'
    ];
    ...
    protected static $setters = [
        ...
        'keyword' => 'setKeyword',
        'top_100_results' => 'setTop100Results'
    ];
    ...
    protected static $getters = [
        ...
        'keyword' => 'getKeyword',
        'top_100_results' => 'getTop100Results'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['top_100_results'] = isset($data['top_100_results']) ? $data['top_100_results'] : null;
    }
     ...
     * Sets keyword_id
     *
     * @param int $keyword_id The unique ID used to identify and reference the keyword in the SEOmonitor system.
     *
     * @return $this
     */
    ...
    /**
     * Gets top_100_results
     *
     * @return \Swagger\Client\Model\Top100Results[]
     */
    public function getTop100Results()
    {
        return $this->container['top_100_results'];
    }

    /**
     * Sets top_100_results
     *
     * @param \Swagger\Client\Model\Top100Results[] $top_100_results Parent field containing keyword ranking data for the competitors selected in the SEOmonitor platform, comprising of their domain, the ranking landing page for the keyword, and ranking data.
     *
     * @return $this
     */
    public function setTop100Results($top_100_results)
    {
        $this->container['top_100_results'] = $top_100_results;
