 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GscData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'gsc-data';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['avg_position'] = isset($data['avg_position']) ? $data['avg_position'] : null;
    }
     ...
     * Sets impressions
     *
     * @param int $impressions The total number of impressions in Google search results for the specified keyword over the specified timeframe.
     *
     * @return $this
     */
     ...
     * Sets clicks
     *
     * @param int $clicks The total number of clicks that the keyword received in Google search results over the specified timeframe.
     *
     * @return $this
     */
     ...
     * Sets avg_position
     *
     * @param int $avg_position The keyword's average position on Google over the specified timeframe, blended for desktop and mobile devices.
     *
     * @return $this
     */
