...
/**
 * CompletionStatus30days Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompletionStatus30days implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'completion-status-30days';
     ...
     *
     * @param int $actual_sessions The number of sessions recorded within the last 30 days.
     *
     * @return $this
     */
     ...
     *
     * @param int $forecasted_sessions The number of sessions estimated to be obtained within the last 30 days.
     *
     * @return $this
     */
