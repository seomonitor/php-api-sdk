...
/**
 * CompletionStatusDateSessions Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompletionStatusDateSessions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'completion-status-date-sessions';
    ...
    protected static $setters = [
        ...
        'forecasted_sessions' => 'setForecastedSessions'
    ];
    ...
    protected static $getters = [
        ...
        'forecasted_sessions' => 'getForecastedSessions'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['forecasted_sessions'] = isset($data['forecasted_sessions']) ? $data['forecasted_sessions'] : null;
    }
     ...
     *
     * @param int $actual_sessions The number of sessions recorded from the start of the forecast to the current date.
     *
     * @return $this
     */
    ...
    /**
     * Gets forecasted_sessions
     *
     * @return int
     */
    public function getForecastedSessions()
    {
        return $this->container['forecasted_sessions'];
    }

    /**
     * Sets forecasted_sessions
     *
     * @param int $forecasted_sessions The number of sessions estimated to be obtained from the start of the forecast to the current date.
     *
     * @return $this
     */
    public function setForecastedSessions($forecasted_sessions)
    {
        $this->container['forecasted_sessions'] = $forecasted_sessions;
