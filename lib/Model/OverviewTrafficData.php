...
/**
 * OverviewTrafficData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OverviewTrafficData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'overview-traffic-data';
     ...
     * Sets traffic
     *
     * @param int $traffic The estimated organic traffic of the campaign website over the past 30 days.
     *
     * @return $this
     */
     ...
     * Sets trend
     *
     * @param double $trend The percentage change in the estimated traffic over the last 30 days compared to the previous 30 days.
     *
     * @return $this
     */
