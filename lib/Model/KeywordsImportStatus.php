...
/**
 * KeywordsImportStatus Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordsImportStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keywords-import-status';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['date_done'] = isset($data['date_done']) ? $data['date_done'] : null;
     ...
     * Sets date_start
     *
     * @param \DateTime $date_start The timestamp when the import task was started.
     *
     * @return $this
     */
    ...
    {
        return $this->container['date_done'];
    }

    /**
     * Sets date_done
     *
     * @param \DateTime $date_done The timestamp when the import task was completed. It returns 'N/A' if the task is still in progress.
     *
     * @return $this
     */
    public function setDateDone($date_done)
    {
        $this->container['date_done'] = $date_done;
     ...
     * Sets imported
     *
     * @param int $imported The number of keywords that have been successfully imported so far.
     *
     * @return $this
     */
     ...
     * Sets processing
     *
     * @param int $processing The number of keywords still being processed and imported.
     *
     * @return $this
     */
