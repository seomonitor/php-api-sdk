...
/**
 * ForecastMonthlyForecasts Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastMonthlyForecasts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-monthly-forecasts';
    ...
    protected static $swaggerTypes = [
        'month' => 'string',
        'seasonality' => 'double',
        'traffic_data' => '\Swagger\Client\Model\ForecastMonthlyForecastsTraffic'
    ];
     ...
     * Sets month
     *
     * @param string $month The month and year in the forecast timeframe for which data is returned.
     *
     * @return $this
     */
     ...
     * Sets seasonality
     *
     * @param double $seasonality The average search seasonality of the keywords included in the forecast scenario for the specific month of the timeframe. The value is returned as a percentage related to the 12-month seasonality average, where 1.00 represents the average value.
     *
     * @return $this
     */
     ...
     * Gets traffic_data
     *
     * @return \Swagger\Client\Model\ForecastMonthlyForecastsTraffic
     */
     ...
     * Sets traffic_data
     *
     * @param \Swagger\Client\Model\ForecastMonthlyForecastsTraffic $traffic_data traffic_data
     *
     * @return $this
     */
