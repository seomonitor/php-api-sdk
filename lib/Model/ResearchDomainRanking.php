...
/**
 * ResearchDomainRanking Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResearchDomainRanking implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'research-domain-ranking';
     ...
     * Sets domain
     *
     * @param string $domain The requested domain for which the ranking data is returned.
     *
     * @return $this
     */
