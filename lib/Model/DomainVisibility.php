...
/**
 * DomainVisibility Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DomainVisibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'domain-visibility';
     ...
     * Sets domain
     *
     * @param string $domain Campaign name or competitor domain
     *
     * @return $this
     */
     ...
     * Sets visibility
     *
     * @param double $visibility Visibility - A numeric value between 0 and 100
     *
     * @return $this
     */
