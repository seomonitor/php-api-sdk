...
/**
 * GroupsFeatureVisibility Class Doc Comment
 *
 * @category Class
 * @description Parent field containing the Visibility for the requested SERP feature, for the date specified.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupsFeatureVisibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'groups-feature-visibility';
     ...
     * Sets desktop
     *
     * @param double $desktop The desktop SERP feature Visibility.
     *
     * @return $this
     */
     ...
     * Sets mobile
     *
     * @param double $mobile The mobile SERP feature Visibility.
     *
     * @return $this
     */
