...
/**
 * GroupsAvgRank Class Doc Comment
 *
 * @category Class
 * @description Parent field containing the average desktop and mobile ranks of the keywords weighted by their search volume, for the date specified.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupsAvgRank implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'groups-avg-rank';
     ...
     * Sets desktop
     *
     * @param int $desktop The average rank of the keywords in the specified group weighted by their search volume, for searches coming from desktop devices.
     *
     * @return $this
     */
     ...
     * Sets mobile
     *
     * @param int $mobile The average rank of the keywords in the specified group weighted by their search volume, for searches coming from mobile devices.
     *
     * @return $this
     */
