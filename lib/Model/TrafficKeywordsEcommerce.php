...
/**
 * TrafficKeywordsEcommerce Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TrafficKeywordsEcommerce implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'traffic-keywords-ecommerce';
     ...
     * Sets transactions
     *
     * @param double $transactions Keyword Transactions
     *
     * @return $this
     */
     ...
     * Sets revenue
     *
     * @param double $revenue Keyword Revenue
     *
     * @return $this
     */
