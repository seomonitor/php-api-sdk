...
/**
 * ForecastAdsEquivalent Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastAdsEquivalent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-ads-equivalent';
    ...
    protected static $setters = [
        'equivalent' => 'setEquivalent',
        'equivalent_best_target' => 'setEquivalentBestTarget'
    ];
    ...
    protected static $getters = [
        ...
        'equivalent_best_target' => 'getEquivalentBestTarget'
    ];
    ...
    {
        $this->container['equivalent'] = isset($data['equivalent']) ? $data['equivalent'] : null;
        $this->container['equivalent_best_target'] = isset($data['equivalent_best_target']) ? $data['equivalent_best_target'] : null;
    }
    ...
    {
        return $this->container['equivalent'];
    }

    /**
     * Sets equivalent
     *
     * @param int $equivalent The equivalent estimated spend if obtaining the same additional traffic through Google Ads alone.  If the `target_rank_range` parameter returns \"true\", the `ads_equivalent` value is the value for the lower (worst) target rank.
     *
     * @return $this
     */
    public function setEquivalent($equivalent)
    {
        $this->container['equivalent'] = $equivalent;

        return $this;
    }

    /**
     * Gets equivalent_best_target
     *
     * @return int
     */
    public function getEquivalentBestTarget()
    {
        return $this->container['equivalent_best_target'];
    }

    /**
     * Sets equivalent_best_target
     *
     * @param int $equivalent_best_target If the `target_rank_range` parameter returns \"true\", this parameter returns the value for the higher (best) target rank.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty.
     *
     * @return $this
     */
    public function setEquivalentBestTarget($equivalent_best_target)
    {
        $this->container['equivalent_best_target'] = $equivalent_best_target;
