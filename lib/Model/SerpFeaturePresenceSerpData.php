...
/**
 * SerpFeaturePresenceSerpData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SerpFeaturePresenceSerpData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'serp-feature-presence-serp-data';
    ...
    protected static $swaggerTypes = [
        'date' => '\DateTime',
        'desktop' => '\Swagger\Client\Model\SerpFeaturePresenceByDevice[]',
        'mobile' => '\Swagger\Client\Model\SerpFeaturePresenceByDevice[]'
    ];
     ...
     * Sets date
     *
     * @param \DateTime $date The date within the selected timeframe when the SERP features were detected.
     *
     * @return $this
     */
     ...
     * Gets desktop
     *
     * @return \Swagger\Client\Model\SerpFeaturePresenceByDevice[]
     */
     ...
     * Sets desktop
     *
     * @param \Swagger\Client\Model\SerpFeaturePresenceByDevice[] $desktop Parent field containing the features present in the desktop SERP on the returned date.
     *
     * @return $this
     */
     ...
     * Sets mobile
     *
     * @param \Swagger\Client\Model\SerpFeaturePresenceByDevice[] $mobile Parent field containing the SERP features detected on searches from mobile devices.
     *
     * @return $this
     */
