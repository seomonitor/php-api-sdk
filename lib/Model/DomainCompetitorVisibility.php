...
/**
 * DomainCompetitorVisibility Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DomainCompetitorVisibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'domain-competitor-visibility';
     ...
     * Sets visibility
     *
     * @param double $visibility The desktop Visibility of the requested domain or URL on the day of the latest crawl which is refreshed within the past 30 days.
     *
     * @return $this
     */
     ...
     * Sets trend
     *
     * @param double $trend The percentage increase or decrease in Visibility of the requested domain or URL over the past two crawl dates.
     *
     * @return $this
     */
