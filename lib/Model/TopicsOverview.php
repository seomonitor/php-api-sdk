...
/**
 * TopicsOverview Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TopicsOverview implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'topics-overview';
     ...
     *
     * @param int $related_keywords The total number of curated keywords returned for the specified topic.
     *
     * @return $this
     */
