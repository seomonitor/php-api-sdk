...
/**
 * KeywordsImportPostBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordsImportPostBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keywords-import-post-body';
     ...
     * Sets campaign_id
     *
     * @param int $campaign_id The ID of the campaign to which you want to add/import keywords.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns.
     *
     * @return $this
     */
     ...
     * Sets keywords
     *
     * @param string $keywords A comma-separated list of new keywords that you want to import into the campaign. E.g. `\"christmas party dresses, christmas sweater, christmas jumpers\"`.  Please refer to the Quick Start Guide to learn how to retrieve the IDs of your keywords.
     *
     * @return $this
     */
