...
/**
 * ForecastAdditionalTraffic Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastAdditionalTraffic implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-additional-traffic';
    ...
    protected static $swaggerFormats = [
        'sessions' => 'int32',
        'sessions_best_target' => 'int32',
        'conversions' => 'int32',
        'conversions_best_target' => 'int32',
        'revenue' => 'int32',
        'revenue_best_target' => 'int32'
    ];
    ...
    protected static $setters = [
        ...
        'sessions_best_target' => 'setSessionsBestTarget',
        'conversions' => 'setConversions',
        'conversions_best_target' => 'setConversionsBestTarget',
        'revenue' => 'setRevenue',
        'revenue_best_target' => 'setRevenueBestTarget'
    ];
    ...
    protected static $getters = [
        ...
        'sessions_best_target' => 'getSessionsBestTarget',
        'conversions' => 'getConversions',
        'conversions_best_target' => 'getConversionsBestTarget',
        'revenue' => 'getRevenue',
        'revenue_best_target' => 'getRevenueBestTarget'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sessions_best_target'] = isset($data['sessions_best_target']) ? $data['sessions_best_target'] : null;
        $this->container['conversions'] = isset($data['conversions']) ? $data['conversions'] : null;
        $this->container['conversions_best_target'] = isset($data['conversions_best_target']) ? $data['conversions_best_target'] : null;
        $this->container['revenue'] = isset($data['revenue']) ? $data['revenue'] : null;
        $this->container['revenue_best_target'] = isset($data['revenue_best_target']) ? $data['revenue_best_target'] : null;
    }
     ...
     * Sets sessions
     *
     * @param int $sessions Parent field containing data related to the estimated Additional Non-Brand Organic Sessions that would be achieved throughout the forecast timeframe.  If the `target_rank_range` parameter returns \"true\", the `sessions` value is the lower (worst) Additional Sessions value.
     *
     * @return $this
     */
    ...
    /**
     * Gets sessions_best_target
     *
     * @return int
     */
    public function getSessionsBestTarget()
    {
        return $this->container['sessions_best_target'];
    }

    /**
     * Sets sessions_best_target
     *
     * @param int $sessions_best_target If the `target_rank_range` parameter returns \"true\", this parameter is the higher (best) Additional Sessions value.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty.
     *
     * @return $this
     */
    public function setSessionsBestTarget($sessions_best_target)
    {
        $this->container['sessions_best_target'] = $sessions_best_target;
     ...
     * Sets conversions
     *
     * @param int $conversions The estimated Additional Non-Brand Organic Conversions that would be achieved throughout the forecast timeframe.  If the `target_rank_range` parameter returns \"true\", the `conversions` value is the lower (worst) Additional Conversions value.
     *
     * @return $this
     */
    ...
    /**
     * Gets conversions_best_target
     *
     * @return int
     */
    public function getConversionsBestTarget()
    {
        return $this->container['conversions_best_target'];
    }

    /**
     * Sets conversions_best_target
     *
     * @param int $conversions_best_target If the `target_rank_range` parameter returns \"true\", this parameter is the higher (best) Additional Conversions value.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty.
     *
     * @return $this
     */
    public function setConversionsBestTarget($conversions_best_target)
    {
        $this->container['conversions_best_target'] = $conversions_best_target;
     ...
     * Sets revenue
     *
     * @param int $revenue The estimated Additional Non-Brand Organic Revenue that would be achieved throughout the forecast timeframe.  If the `target_rank_range` parameter returns \"true\", the `revenue` value is the lower (worst) Additional Revenue value.
     *
     * @return $this
     */
    ...
    /**
     * Gets revenue_best_target
     *
     * @return int
     */
    public function getRevenueBestTarget()
    {
        return $this->container['revenue_best_target'];
    }

    /**
     * Sets revenue_best_target
     *
     * @param int $revenue_best_target If the `target_rank_range` parameter returns \"true\", this parameter is the higher (best) Additional Revenue value.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty.
     *
     * @return $this
     */
    public function setRevenueBestTarget($revenue_best_target)
    {
        $this->container['revenue_best_target'] = $revenue_best_target;
