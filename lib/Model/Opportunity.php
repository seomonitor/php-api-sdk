...
class Opportunity implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'score' => 'int',
        'additional_montly_sessions' => '\Swagger\Client\Model\OpportunityTop3Values',
        'difficulty' => 'string',
        'avg_cpc' => 'double'
    ];
    ...
    protected static $swaggerFormats = [
        'score' => null,
        'additional_montly_sessions' => null,
        'difficulty' => null,
        'avg_cpc' => 'double'
    ];
    ...
    protected static $setters = [
        'score' => 'setScore',
        'additional_montly_sessions' => 'setAdditionalMontlySessions',
    ...
    protected static $getters = [
        'score' => 'getScore',
        'additional_montly_sessions' => 'getAdditionalMontlySessions',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['additional_montly_sessions'] = isset($data['additional_montly_sessions']) ? $data['additional_montly_sessions'] : null;
     ...
     * Sets score
     *
     * @param int $score The Opportunity score from 0 to 10.  For the keywords where the Opportunity score is not computed, the value returned will be \"N/A\".
     *
     * @return $this
     */
    ...
    /**
     * Gets additional_montly_sessions
     *
     * @return \Swagger\Client\Model\OpportunityTop3Values
     */
    public function getAdditionalMontlySessions()
    {
        return $this->container['additional_montly_sessions'];
    }

    /**
     * Sets additional_montly_sessions
     *
     * @param \Swagger\Client\Model\OpportunityTop3Values $additional_montly_sessions additional_montly_sessions
     *
     * @return $this
     */
    public function setAdditionalMontlySessions($additional_montly_sessions)
    {
        $this->container['additional_montly_sessions'] = $additional_montly_sessions;
     ...
     * Sets difficulty
     *
     * @param string $difficulty The Difficulty level of the keyword to rank in Top10. Possible values are \"already_top_10\", \"easy\", \"medium\", \"hard\".
     *
     * @return $this
     */
     ...
     * Sets avg_cpc
     *
     * @param double $avg_cpc The keyword's average cost per click in the currency of the campaign.
     *
     * @return $this
     */
