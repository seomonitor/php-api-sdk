...
/**
 * ForecastSeoGoal Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastSeoGoal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-seo-goal';
    ...
    protected static $swaggerTypes = [
        'keywords_count' => 'int',
        'search_data' => '\Swagger\Client\Model\ForecastScenarioSearchData',
        'target' => '\Swagger\Client\Model\ForecastTargetData',
        'goal_chance' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['goal_chance'] = isset($data['goal_chance']) ? $data['goal_chance'] : null;
    }
     ...
     * Sets keywords_count
     *
     * @param int $keywords_count The total number of keywords included in the Objective.
     *
     * @return $this
     */
     ...
     * Gets search_data
     *
     * @return \Swagger\Client\Model\ForecastScenarioSearchData
     */
     ...
     * Sets search_data
     *
     * @param \Swagger\Client\Model\ForecastScenarioSearchData $search_data search_data
     *
     * @return $this
     */
     ...
     * Gets target
     *
     * @return \Swagger\Client\Model\ForecastTargetData
     */
     ...
     * Sets target
     *
     * @param \Swagger\Client\Model\ForecastTargetData $target target
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getGoalChance()
    {
        return $this->container['goal_chance'];
    }

    /**
     * Sets goal_chance
     *
     * @param string $goal_chance The chance of achieving the target ranks considering the average Difficulty of the keywords weighted by Additional Sessions, the average Target Rank and the Initial Rank, and the configured Progression Speed.  Possible values are `realistic`, `ambitious`, or `too ambitious`.
     *
     * @return $this
     */
    public function setGoalChance($goal_chance)
    {
        $this->container['goal_chance'] = $goal_chance;
