...
/**
 * KeywordSerpResult Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordSerpResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keyword-serp-result';
     ...
     * Sets rank
     *
     * @param int $rank Serp result rank
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url Serp result url
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Serp result description
     *
     * @return $this
     */
