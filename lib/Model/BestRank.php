...
/**
 * BestRank Class Doc Comment
 *
 * @category Class
 * @description Parent field containing the highest position the keyword ranked on Google since it was tracked in the app and the date when it was recorded, for desktop devices.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BestRank implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'best_rank';
     ...
     * Sets rank
     *
     * @param int $rank The highest position the keyword ranked on Google since it was tracked in the app.
     *
     * @return $this
     */
     ...
     * Sets date
     *
     * @param \DateTime $date The latest date when the keyword reached the highest position on Google since it was tracked in the app, for desktop devices.
     *
     * @return $this
     */
