...
/**
 * MonthlySearches Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MonthlySearches implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'monthly-searches';
     ...
     * Sets search_volume
     *
     * @param int $search_volume The search volume recorded.
     *
     * @return $this
     */
     ...
     * Sets month
     *
     * @param string $month The month for which the search volume is recorded.
     *
     * @return $this
     */
     ...
     * Sets year
     *
     * @param int $year The year for the month for which the search volume is recorded.
     *
     * @return $this
     */
