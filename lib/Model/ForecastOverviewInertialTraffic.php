...
/**
 * ForecastOverviewInertialTraffic Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastOverviewInertialTraffic implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-overview-inertial-traffic';
     ...
     * Sets sessions
     *
     * @param int $sessions The estimated Inertial Non-Brand Organic Sessions that would be achieved throughout the forecast timeframe if the ranks remained the same as the current ranks, plotted on the search trends.
     *
     * @return $this
     */
     ...
     * Sets conversions
     *
     * @param int $conversions The estimated Inertial Non-Brand Organic Conversions that would be achieved throughout the forecast timeframe if the ranks remained the same as the current ranks.
     *
     * @return $this
     */
     ...
     * Sets revenue
     *
     * @param int $revenue The estimated Inertial Non-Brand Organic Revenue that would be achieved throughout the forecast timeframe if the ranks remained the same as the current ranks.
     *
     * @return $this
     */
