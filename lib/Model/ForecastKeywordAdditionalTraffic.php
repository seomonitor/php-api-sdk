...
/**
 * ForecastKeywordAdditionalTraffic Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastKeywordAdditionalTraffic implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-keyword-additional-traffic';
    ...
    protected static $swaggerFormats = [
        'sessions' => null,
        'sessions_best_target' => null,
        'conversions' => null,
        'conversions_best_target' => null,
        'revenue' => null,
        'revenue_best_target' => null
    ];
     ...
     *
     * @param int $sessions_best_target If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.
     *
     * @return $this
     */
     ...
     *
     * @param int $conversions_best_target If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.
     *
     * @return $this
     */
     ...
     *
     * @param int $revenue_best_target If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.
     *
     * @return $this
     */
