...
/**
 * GroupsSerpMobileDesktop Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupsSerpMobileDesktop implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'groups-serp-mobile-desktop';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['presence_count'] = isset($data['presence_count']) ? $data['presence_count'] : null;
     ...
     * Sets feature
     *
     * @param string $feature The abbreviated name of the SERP feature.
     *
     * @return $this
     */
     ...
     * Sets presence_count
     *
     * @param int $presence_count The number of keywords for which the specific SERP feature is present in the results on the last day of the selected timeframe.
     *
     * @return $this
     */
    public function setPresenceCount($presence_count)
    {
     ...
     * Sets listed_count
     *
     * @param int $listed_count Out of the `presence_count`, the number of SERP features in which the website is listed on the last day of the selected timeframe.
     *
     * @return $this
     */
