...
/**
 * AddCampaignPostBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddCampaignPostBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'add-campaign-post-body';
     ...
     * Sets campaign_url
     *
     * @param string $campaign_url The domain of the campaign you want to add.
     *
     * @return $this
     */
     ...
     * Sets location_code
     *
     * @param string $location_code The location code for the campaign you want to add. This can be obtained by calling the Get Locations endpoint (/campaign-management/v3.0/locations).
     *
     * @return $this
     */
     ...
     * Sets company_id
     *
     * @param int $company_id The id of the company where the campaign will be added. Required only if user has access to multiple companies.
     *
     * @return $this
     */
