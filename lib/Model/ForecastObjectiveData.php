...
/**
 * ForecastObjectiveData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastObjectiveData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-objective-data';
    ...
    protected static $swaggerTypes = [
        'objective_data' => '\Swagger\Client\Model\ForecastObjectiveDetails',
        'seo_goal' => '\Swagger\Client\Model\ForecastSeoGoal',
        'scenario_configuration' => '\Swagger\Client\Model\ForecastConfiguration',
        'overview_data' => '\Swagger\Client\Model\ForecastOverviewData',
        'monthly_forecast' => '\Swagger\Client\Model\ForecastMonthlyForecasts',
        'monthly_forecast_extended' => '\Swagger\Client\Model\ForecastMonthlyForecasts'
    ];
    ...
    protected static $swaggerFormats = [
        'objective_data' => null,
        'seo_goal' => null,
        'scenario_configuration' => null,
        'overview_data' => null,
        'monthly_forecast' => null,
        'monthly_forecast_extended' => null
    ];
    ...
    protected static $setters = [
        'objective_data' => 'setObjectiveData',
        'seo_goal' => 'setSeoGoal',
        'scenario_configuration' => 'setScenarioConfiguration',
        'overview_data' => 'setOverviewData',
        'monthly_forecast' => 'setMonthlyForecast',
        'monthly_forecast_extended' => 'setMonthlyForecastExtended'
    ];
    ...
    protected static $getters = [
        'objective_data' => 'getObjectiveData',
        'seo_goal' => 'getSeoGoal',
        'scenario_configuration' => 'getScenarioConfiguration',
        'overview_data' => 'getOverviewData',
        'monthly_forecast' => 'getMonthlyForecast',
        'monthly_forecast_extended' => 'getMonthlyForecastExtended'
    ];
    ...
    {
        $this->container['objective_data'] = isset($data['objective_data']) ? $data['objective_data'] : null;
        $this->container['seo_goal'] = isset($data['seo_goal']) ? $data['seo_goal'] : null;
        $this->container['scenario_configuration'] = isset($data['scenario_configuration']) ? $data['scenario_configuration'] : null;
        $this->container['overview_data'] = isset($data['overview_data']) ? $data['overview_data'] : null;
        $this->container['monthly_forecast'] = isset($data['monthly_forecast']) ? $data['monthly_forecast'] : null;
        $this->container['monthly_forecast_extended'] = isset($data['monthly_forecast_extended']) ? $data['monthly_forecast_extended'] : null;
    }
     ...
     * Gets objective_data
     *
     * @return \Swagger\Client\Model\ForecastObjectiveDetails
     */
    public function getObjectiveData()
    {
        return $this->container['objective_data'];
    }

    /**
     * Sets objective_data
     *
     * @param \Swagger\Client\Model\ForecastObjectiveDetails $objective_data objective_data
     *
     * @return $this
     */
    public function setObjectiveData($objective_data)
    {
        $this->container['objective_data'] = $objective_data;
     ...
     * Gets seo_goal
     *
     * @return \Swagger\Client\Model\ForecastSeoGoal
     */
    public function getSeoGoal()
    {
        return $this->container['seo_goal'];
    }

    /**
     * Sets seo_goal
     *
     * @param \Swagger\Client\Model\ForecastSeoGoal $seo_goal seo_goal
     *
     * @return $this
     */
    public function setSeoGoal($seo_goal)
    {
        $this->container['seo_goal'] = $seo_goal;

        return $this;
    }

    /**
     * Gets scenario_configuration
     *
     * @return \Swagger\Client\Model\ForecastConfiguration
     */
    public function getScenarioConfiguration()
    {
        return $this->container['scenario_configuration'];
    }

    /**
     * Sets scenario_configuration
     *
     * @param \Swagger\Client\Model\ForecastConfiguration $scenario_configuration scenario_configuration
     *
     * @return $this
     */
    public function setScenarioConfiguration($scenario_configuration)
    {
        $this->container['scenario_configuration'] = $scenario_configuration;
     ...
     * Gets overview_data
     *
     * @return \Swagger\Client\Model\ForecastOverviewData
     */
    public function getOverviewData()
    {
        return $this->container['overview_data'];
    }

    /**
     * Sets overview_data
     *
     * @param \Swagger\Client\Model\ForecastOverviewData $overview_data overview_data
     *
     * @return $this
     */
    public function setOverviewData($overview_data)
    {
        $this->container['overview_data'] = $overview_data;

        return $this;
    }

    /**
     * Gets monthly_forecast
     *
     * @return \Swagger\Client\Model\ForecastMonthlyForecasts
     */
    public function getMonthlyForecast()
    {
        return $this->container['monthly_forecast'];
    }

    /**
     * Sets monthly_forecast
     *
     * @param \Swagger\Client\Model\ForecastMonthlyForecasts $monthly_forecast monthly_forecast
     *
     * @return $this
     */
    public function setMonthlyForecast($monthly_forecast)
    {
        $this->container['monthly_forecast'] = $monthly_forecast;

        return $this;
    }

    /**
     * Gets monthly_forecast_extended
     *
     * @return \Swagger\Client\Model\ForecastMonthlyForecasts
     */
    public function getMonthlyForecastExtended()
    {
        return $this->container['monthly_forecast_extended'];
    }

    /**
     * Sets monthly_forecast_extended
     *
     * @param \Swagger\Client\Model\ForecastMonthlyForecasts $monthly_forecast_extended monthly_forecast_extended
     *
     * @return $this
     */
    public function setMonthlyForecastExtended($monthly_forecast_extended)
    {
        $this->container['monthly_forecast_extended'] = $monthly_forecast_extended;
