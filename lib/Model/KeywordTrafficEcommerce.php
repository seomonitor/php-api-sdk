...
/**
 * KeywordTrafficEcommerce Class Doc Comment
 *
 * @category Class
 * @description An object containing the information about the transactions aggregated as sums for the specific timeframe.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordTrafficEcommerce implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keyword-traffic-ecommerce';
     ...
     * Sets transactions
     *
     * @param int $transactions Sum of transactions uncovered from not-provided whitin the selected timeframe. Data is available only if an Analytics  profile is connected.
     *
     * @return $this
     */
     ...
     * Sets revenue
     *
     * @param int $revenue Total ecommerce revenue uncovered through the (not provided) solution within the selected timeframe.
     *
     * @return $this
     */
