...
/**
 * GroupsVisibility Class Doc Comment
 *
 * @category Class
 * @description Parent field containing the desktop and mobile Visibility metrics of the requested domain for the date specified.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupsVisibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'groups-visibility';
     ...
     * Sets desktop
     *
     * @param double $desktop The desktop Visibility of the requested domain.
     *
     * @return $this
     */
     ...
     * Sets mobile
     *
     * @param double $mobile The mobile Visibility of the requested domain.
     *
     * @return $this
     */
