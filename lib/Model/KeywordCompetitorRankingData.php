...
/**
 * KeywordCompetitorRankingData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordCompetitorRankingData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keyword-competitor-ranking-data';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rank_trend'] = isset($data['rank_trend']) ? $data['rank_trend'] : null;
    }
     ...
     * Sets rank
     *
     * @param int $rank The current organic search ranking position of the competitor landing page for this specific keyword on Google.
     *
     * @return $this
     */
    ...
    {
        return $this->container['rank_trend'];
    }

    /**
     * Sets rank_trend
     *
     * @param int $rank_trend The root domain name of the competitor.
     *
     * @return $this
     */
    public function setRankTrend($rank_trend)
    {
        $this->container['rank_trend'] = $rank_trend;
