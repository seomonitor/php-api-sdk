...
/**
 * Top100Results Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Top100Results implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'top-100-results';
     ...
     * Sets domain
     *
     * @param string $domain The root domain name of the competitor.
     *
     * @return $this
     */
     ...
     * Sets landing_page
     *
     * @param string $landing_page The full URL path of the page on the competitor's site that is currently ranking for this exact keyword.
     *
     * @return $this
     */
     ...
     * Sets rank
     *
     * @param int $rank The organic search ranking position of this specific result for the keyword on Google.
     *
     * @return $this
     */
     ...
     * Sets search_intent
     *
     * @param string $search_intent The main search intent of the landing page. Possible values are `informational`, `commercial`, and `transactional`.
     *
     * @return $this
     */
