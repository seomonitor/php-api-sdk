...
/**
 * ForecastTrafficConversions Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastTrafficConversions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-traffic-conversions';
     ...
     * Sets inertial
     *
     * @param int $inertial The number of inertial conversions.
     *
     * @return $this
     */
     ...
     * Sets additional
     *
     * @param int $additional The number of additional conversions.  If the `target_rank_range` parameter returns \"true\", this is the value calculated for the lower (worst) target rank.
     *
     * @return $this
     */
