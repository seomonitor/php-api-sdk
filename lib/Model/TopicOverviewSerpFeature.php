...
/**
 * TopicOverviewSerpFeature Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TopicOverviewSerpFeature implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'topic-overview-serp-feature';
     ...
     * Sets count
     *
     * @param int $count The number of keywords for which the SERP feature is present in the results.
     *
     * @return $this
     */
