...
/**
 * ForecastTargetAvgRank Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastTargetAvgRank implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-target-avg-rank';
    ...
    protected static $setters = [
        ...
        'best_target_rank' => 'setBestTargetRank'
    ];
    ...
    protected static $getters = [
        ...
        'best_target_rank' => 'getBestTargetRank'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['best_target_rank'] = isset($data['best_target_rank']) ? $data['best_target_rank'] : null;
    }
     ...
     * Sets initial_rank
     *
     * @param int $initial_rank The average initial rank of the keywords included in the scenario, calculated for the month when the scenario was created.
     *
     * @return $this
     */
     ...
     * Sets trend_3months
     *
     * @param int $trend_3months The average increase or drop in positions of the keywords in the scenario, over the previous 3 months up to the month the scenario was created, weighted by the keywords' search volume.
     *
     * @return $this
     */
     ...
     * Sets target_rank
     *
     * @param int $target_rank The average target rank of the keywords in the Objective. If the `target_rank_range` parameter returns \"true\", the `target_rank` is the lower (worst) average target rank.
     *
     * @return $this
     */
    ...
    /**
     * Gets best_target_rank
     *
     * @return int
     */
    public function getBestTargetRank()
    {
        return $this->container['best_target_rank'];
    }

    /**
     * Sets best_target_rank
     *
     * @param int $best_target_rank If the `target_rank_range` parameter returns \"true\", this parameter is the higher (best) average target rank. If the `target_rank_range` parameter returns \"false\", this parameter will return empty.
     *
     * @return $this
     */
    public function setBestTargetRank($best_target_rank)
    {
        $this->container['best_target_rank'] = $best_target_rank;
