...
/**
 * CampaignVisibilityTimeframes Class Doc Comment
 *
 * @category Class
 * @description The Visibility shows your website’s share of the total searches (impressions), out of the total potential it could get.  Performance is the Visibility trend generated by the keywords tracked throughout the entire selected timeframe (so ignoring the ones added later than the start date, for example)
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CampaignVisibilityTimeframes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'campaign-visibility-timeframes';
    ...
    protected static $swaggerTypes = [
        'desktop' => '\Swagger\Client\Model\VisbilityAndPerformance',
        'mobile' => '\Swagger\Client\Model\VisbilityAndPerformance',
        'blended' => '\Swagger\Client\Model\VisbilityAndPerformance'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['blended'] = isset($data['blended']) ? $data['blended'] : null;
    }
     ...
     * Gets desktop
     *
     * @return \Swagger\Client\Model\VisbilityAndPerformance
     */
     ...
     * Sets desktop
     *
     * @param \Swagger\Client\Model\VisbilityAndPerformance $desktop desktop
     *
     * @return $this
     */
     ...
     * Sets mobile
     *
     * @param \Swagger\Client\Model\VisbilityAndPerformance $mobile mobile
     *
     * @return $this
     */
    ...
    {
        return $this->container['blended'];
    }

    /**
     * Sets blended
     *
     * @param \Swagger\Client\Model\VisbilityAndPerformance $blended blended
     *
     * @return $this
     */
    public function setBlended($blended)
    {
        $this->container['blended'] = $blended;
