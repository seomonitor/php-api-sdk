...
/**
 * ForecastMonthlyForecastTrafficSessions Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastMonthlyForecastTrafficSessions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-monthly-forecast-traffic-sessions';
    ...
    protected static $setters = [
        ...
        'additional_best_target' => 'setAdditionalBestTarget'
    ];
    ...
    protected static $getters = [
        ...
        'additional_best_target' => 'getAdditionalBestTarget'
    ];
    ...
    {
        $this->container['inertial'] = isset($data['inertial']) ? $data['inertial'] : null;
        $this->container['additional'] = isset($data['additional']) ? $data['additional'] : null;
        $this->container['additional_best_target'] = isset($data['additional_best_target']) ? $data['additional_best_target'] : null;
    }
     ...
     * @return int
     */
    public function getInertial()
    {
        return $this->container['inertial'];
    }

    /**
     * Sets inertial
     *
     * @param int $inertial The number of Inertial Sessions.
     *
     * @return $this
     */
    public function setInertial($inertial)
    {
        $this->container['inertial'] = $inertial;
     ...
     * Sets additional
     *
     * @param int $additional The number of Additional Sessions.  If the `target_rank_range` parameter returns \"true\", this is the value calculated for the lower (worst) target rank.
     *
     * @return $this
     */
    ...
    /**
     * Gets additional_best_target
     *
     * @return int
     */
    public function getAdditionalBestTarget()
    {
        return $this->container['additional_best_target'];
    }

    /**
     * Sets additional_best_target
     *
     * @param int $additional_best_target If the `target_rank_range` parameter returns \"true\", this parameter returns the value calculated for the higher (best) target rank.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty.
     *
     * @return $this
     */
    public function setAdditionalBestTarget($additional_best_target)
    {
        $this->container['additional_best_target'] = $additional_best_target;
