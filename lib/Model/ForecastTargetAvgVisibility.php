...
/**
 * ForecastTargetAvgVisibility Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastTargetAvgVisibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-target-avg-visibility';
    ...
    protected static $swaggerTypes = [
        'initial_visibility' => 'double',
        'trend_3months' => 'double',
        'target_visibility' => 'double',
    ...
    protected static $setters = [
        'initial_visibility' => 'setInitialVisibility',
        'trend_3months' => 'setTrend3months',
        'target_visibility' => 'setTargetVisibility',
        'best_target_visibility' => 'setBestTargetVisibility'
    ];
    ...
    protected static $getters = [
        'initial_visibility' => 'getInitialVisibility',
        'trend_3months' => 'getTrend3months',
        'target_visibility' => 'getTargetVisibility',
        'best_target_visibility' => 'getBestTargetVisibility'
    ];
    ...
    {
        $this->container['initial_visibility'] = isset($data['initial_visibility']) ? $data['initial_visibility'] : null;
        $this->container['trend_3months'] = isset($data['trend_3months']) ? $data['trend_3months'] : null;
        $this->container['target_visibility'] = isset($data['target_visibility']) ? $data['target_visibility'] : null;
        $this->container['best_target_visibility'] = isset($data['best_target_visibility']) ? $data['best_target_visibility'] : null;
    }
    ...
    /**
     * Gets initial_visibility
     *
     * @return double
     */
    public function getInitialVisibility()
    {
        return $this->container['initial_visibility'];
    }

    /**
     * Sets initial_visibility
     *
     * @param double $initial_visibility The average Visibility calculated for the keywords included in the Objective for the month when the scenario was created.
     *
     * @return $this
     */
    public function setInitialVisibility($initial_visibility)
    {
        $this->container['initial_visibility'] = $initial_visibility;
     ...
     * @return double
     */
    public function getTrend3months()
    {
        return $this->container['trend_3months'];
    }

    /**
     * Sets trend_3months
     *
     * @param double $trend_3months The average increase or drop in Visibility for the keywords in the Objective, over the previous 3 months up to the month the scenario was created, weighted by the keywords' search volume.
     *
     * @return $this
     */
    public function setTrend3months($trend_3months)
    {
        $this->container['trend_3months'] = $trend_3months;

        return $this;
    }

    /**
     * Gets target_visibility
     *
     * @return double
     */
    public function getTargetVisibility()
    {
        return $this->container['target_visibility'];
    }

    /**
     * Sets target_visibility
     *
     * @param double $target_visibility The average target Visibility for the keywords in the Objective. If the `target_rank_range` parameter returns \"true\", the `target_visibility` is the lower (worst) average target Visibility.
     *
     * @return $this
     */
    public function setTargetVisibility($target_visibility)
    {
        $this->container['target_visibility'] = $target_visibility;

        return $this;
    }

    /**
     * Gets best_target_visibility
     *
     * @return int
     */
    public function getBestTargetVisibility()
    {
        return $this->container['best_target_visibility'];
    }

    /**
     * Sets best_target_visibility
     *
     * @param int $best_target_visibility If the `target_rank_range` parameter returns \"true\", this parameter is the higher (best) average target Visibility. If the `target_rank_range` parameter returns \"false\", this parameter will return empty.
     *
     * @return $this
     */
    public function setBestTargetVisibility($best_target_visibility)
    {
        $this->container['best_target_visibility'] = $best_target_visibility;
