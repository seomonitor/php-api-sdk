...
/**
 * GroupKeywordCounters Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupKeywordCounters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'group_keyword_counters';
    ...
    protected static $setters = [
        'main_keywords' => 'setMainKeywords',
        'close_variations' => 'setCloseVariations'
    ];
    ...
    protected static $getters = [
        'main_keywords' => 'getMainKeywords',
        'close_variations' => 'getCloseVariations'
    ];
    ...
    {
        $this->container['main_keywords'] = isset($data['main_keywords']) ? $data['main_keywords'] : null;
        $this->container['close_variations'] = isset($data['close_variations']) ? $data['close_variations'] : null;
    }
     ...
     * @return int
     */
    public function getMainKeywords()
    {
        return $this->container['main_keywords'];
    }

    /**
     * Sets main_keywords
     *
     * @param int $main_keywords The total number of main keywords (non-close variations) present in the group.
     *
     * @return $this
     */
    public function setMainKeywords($main_keywords)
    {
        $this->container['main_keywords'] = $main_keywords;

        return $this;
    }

    /**
     * Gets close_variations
     *
     * @return int
     */
    public function getCloseVariations()
    {
        return $this->container['close_variations'];
    }

    /**
     * Sets close_variations
     *
     * @param int $close_variations The total number of close variations present in the group.
     *
     * @return $this
     */
    public function setCloseVariations($close_variations)
    {
        $this->container['close_variations'] = $close_variations;
