...
/**
 * ForecastKeywordData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastKeywordData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-keyword-data';
     ...
     *
     * @param double $percentage_clicks The percentage of searches that end up clicking on organic results for the keyword, based on the sum of Top 10 positions' CTRs after discounting the searches satisfied by SERP features.
     *
     * @return $this
     */
     ...
     * Sets search_volume
     *
     * @param int $search_volume The latest search volume of the keyword as provided by Google Ads.
     *
     * @return $this
     */
     ...
     * Sets year_over_year
     *
     * @param double $year_over_year The Year-over-Year search trend for the keyword, calculated as last month's search volume compared to one year ago, as provided by Google Ads.
     *
     * @return $this
     */
     ...
     * Sets difficulty
     *
     * @param string $difficulty The normalized difficulty level of the keyword - \"easy\", \"medium\", \"hard\". Provides an indication of how challenging it is expected to be to rank on this keyword in the top 10.
     *
     * @return $this
     */
