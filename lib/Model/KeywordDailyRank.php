...
/**
 * KeywordDailyRank Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordDailyRank implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keyword-daily-rank';
     ...
     * Sets date
     *
     * @param \DateTime $date The date of the rank.
     *
     * @return $this
     */
     ...
     * Sets rank
     *
     * @param int $rank The rank of the keyword on the day of the date field.
     *
     * @return $this
     */
