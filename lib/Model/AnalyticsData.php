...
class AnalyticsData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'analytics-data';
     ...
     * Sets sessions
     *
     * @param int $sessions The sum of sessions, if the campaign is connected to both Google Search Console and Google Analytics – or clicks, if the campaign is only connected to Google Search Console, over the selected timeframe.
     *
     * @return $this
     */
