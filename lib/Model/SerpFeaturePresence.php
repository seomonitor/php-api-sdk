...
/**
 * SerpFeaturePresence Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SerpFeaturePresence implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'serp-feature-presence';
    ...
    protected static $swaggerTypes = [
        'keyword_id' => 'int',
        'keyword' => 'string',
        'serp_data' => '\Swagger\Client\Model\SerpFeaturePresenceSerpData[]'
    ];
     ...
     * Gets serp_data
     *
     * @return \Swagger\Client\Model\SerpFeaturePresenceSerpData[]
     */
     ...
     * Sets serp_data
     *
     * @param \Swagger\Client\Model\SerpFeaturePresenceSerpData[] $serp_data Parent field containing the data for SERP features present on the keyword for each day of the selected timeframe, for each device.  Please refer to the Quick Start Guide for the complete feature name of each abbreviation.
     *
     * @return $this
     */
