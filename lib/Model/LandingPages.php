...
/**
 * LandingPages Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LandingPages implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'landing-pages';
     ...
     * Sets current
     *
     * @param string $current The landing page that is currently ranking for the keyword on Google searches performed from mobile devices.
     *
     * @return $this
     */
     ...
     * Sets desired
     *
     * @param string $desired The landing page you target to rank with on Google searches performed from mobile devices.
     *
     * @return $this
     */
