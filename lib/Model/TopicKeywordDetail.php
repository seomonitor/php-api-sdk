...
/**
 * TopicKeywordDetail Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TopicKeywordDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'topic-keyword-detail';
    ...
    protected static $swaggerTypes = [
        ...
        'search_data' => '\Swagger\Client\Model\ResearchSearchData',
        'ranking_data' => '\Swagger\Client\Model\ResearchRankingData',
        'serp_data' => '\Swagger\Client\Model\ResearchSerpData',
    ...
    protected static $setters = [
        'keyword' => 'setKeyword',
        'connection_strength' => 'setConnectionStrength',
        'search_data' => 'setSearchData',
        'ranking_data' => 'setRankingData',
        'serp_data' => 'setSerpData',
        'tracked_keyword_id' => 'setTrackedKeywordId'
    ];
    ...
    protected static $getters = [
        'keyword' => 'getKeyword',
        'connection_strength' => 'getConnectionStrength',
        'search_data' => 'getSearchData',
        'ranking_data' => 'getRankingData',
        'serp_data' => 'getSerpData',
        'tracked_keyword_id' => 'getTrackedKeywordId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['connection_strength'] = isset($data['connection_strength']) ? $data['connection_strength'] : null;
        ...
        $this->container['tracked_keyword_id'] = isset($data['tracked_keyword_id']) ? $data['tracked_keyword_id'] : null;
    }
     ...
     * Sets keyword
     *
     * @param string $keyword The exact keyword phrase for the returned related keyword.
     *
     * @return $this
     */
    ...
    /**
     * Gets connection_strength
     *
     * @return int
     */
    public function getConnectionStrength()
    {
        return $this->container['connection_strength'];
    }

    /**
     * Sets connection_strength
     *
     * @param int $connection_strength The strength of the connection between the related keyword returned and the topic specified, in a range from 1 to 5, where 5 is a very strong connection.
     *
     * @return $this
     */
    public function setConnectionStrength($connection_strength)
    {
        $this->container['connection_strength'] = $connection_strength;
     ...
     * Gets search_data
     *
     * @return \Swagger\Client\Model\ResearchSearchData
     */
     ...
     * Sets search_data
     *
     * @param \Swagger\Client\Model\ResearchSearchData $search_data search_data
     *
     * @return $this
     */
     ...
     * Gets ranking_data
     *
     * @return \Swagger\Client\Model\ResearchRankingData
     */
     ...
     * Sets ranking_data
     *
     * @param \Swagger\Client\Model\ResearchRankingData $ranking_data ranking_data
     *
     * @return $this
     */
     ...
     * Gets serp_data
     *
     * @return \Swagger\Client\Model\ResearchSerpData
     */
     ...
     * Sets serp_data
     *
     * @param \Swagger\Client\Model\ResearchSerpData $serp_data serp_data
     *
     * @return $this
     */
    ...
    /**
     * Gets tracked_keyword_id
     *
     * @return int
     */
    public function getTrackedKeywordId()
    {
        return $this->container['tracked_keyword_id'];
    }

    /**
     * Sets tracked_keyword_id
     *
     * @param int $tracked_keyword_id The unique ID used to identify and reference the keyword in the system. Returned only if the keyword is tracked in the SEOmonitor campaign. It can be stored and used in other endpoints for filtering.
     *
     * @return $this
     */
    public function setTrackedKeywordId($tracked_keyword_id)
    {
        $this->container['tracked_keyword_id'] = $tracked_keyword_id;
