...
/**
 * DomainRankingKeywordsData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DomainRankingKeywordsData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'domain-ranking-keywords-data';
    ...
    protected static $swaggerTypes = [
        'updated_on' => '\DateTime',
        'my_rank' => '\Swagger\Client\Model\DomainCompetitorRank',
        'competitor_rank' => '\Swagger\Client\Model\DomainCompetitorRank'
    ];
    ...
    protected static $setters = [
        ...
        'my_rank' => 'setMyRank',
        'competitor_rank' => 'setCompetitorRank'
    ];
    ...
    protected static $getters = [
        ...
        'my_rank' => 'getMyRank',
        'competitor_rank' => 'getCompetitorRank'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['my_rank'] = isset($data['my_rank']) ? $data['my_rank'] : null;
        $this->container['competitor_rank'] = isset($data['competitor_rank']) ? $data['competitor_rank'] : null;
    }
     ...
     * Sets updated_on
     *
     * @param \DateTime $updated_on The date when the latest crawl was performed, in YYYY-MM-DD format.
     *
     * @return $this
     */
     ...
     * Gets my_rank
     *
     * @return \Swagger\Client\Model\DomainCompetitorRank
     */
    public function getMyRank()
    {
        return $this->container['my_rank'];
    }

    /**
     * Sets my_rank
     *
     * @param \Swagger\Client\Model\DomainCompetitorRank $my_rank my_rank
     *
     * @return $this
     */
    public function setMyRank($my_rank)
    {
        $this->container['my_rank'] = $my_rank;

        return $this;
    }

    /**
     * Gets competitor_rank
     *
     * @return \Swagger\Client\Model\DomainCompetitorRank
     */
    public function getCompetitorRank()
    {
        return $this->container['competitor_rank'];
    }

    /**
     * Sets competitor_rank
     *
     * @param \Swagger\Client\Model\DomainCompetitorRank $competitor_rank competitor_rank
     *
     * @return $this
     */
    public function setCompetitorRank($competitor_rank)
    {
        $this->container['competitor_rank'] = $competitor_rank;
