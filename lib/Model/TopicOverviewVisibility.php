...
/**
 * TopicOverviewVisibility Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TopicOverviewVisibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'topic-overview-visibility';
     ...
     * Sets visibility
     *
     * @param double $visibility The desktop Visibility of your website on the day of the latest crawl which is refreshed within the past 30 days.
     *
     * @return $this
     */
     ...
     * Sets trend
     *
     * @param double $trend The percentage increase or decrease in your desktop Visibility over the past two crawl dates.
     *
     * @return $this
     */
