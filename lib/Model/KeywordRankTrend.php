...
/**
 * KeywordRankTrend Class Doc Comment
 *
 * @category Class
 * @description An object containing information about the ranking data on Google search on specific device (desktop or mobile).
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordRankTrend implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keyword-rank-trend';
    ...
    protected static $swaggerTypes = [
        ...
        'trend' => 'int',
        'trend_impact' => 'int',
        'best_rank' => '\Swagger\Client\Model\BestRank'
    ];
    ...
    protected static $setters = [
        'rank' => 'setRank',
        'trend' => 'setTrend',
        'trend_impact' => 'setTrendImpact',
        'best_rank' => 'setBestRank'
    ];
    ...
    protected static $getters = [
        'rank' => 'getRank',
        'trend' => 'getTrend',
        'trend_impact' => 'getTrendImpact',
        'best_rank' => 'getBestRank'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['trend_impact'] = isset($data['trend_impact']) ? $data['trend_impact'] : null;
        $this->container['best_rank'] = isset($data['best_rank']) ? $data['best_rank'] : null;
    }
     ...
     * Sets rank
     *
     * @param int $rank The keyword's position on Google at the end of the selected timeframe.
     *
     * @return $this
     */
     ...
     * Sets trend
     *
     * @param int $trend The difference in positions on Google between the start and the end of the timeframe.
     *
     * @return $this
     */
     ...
     * @return int
     */
    public function getTrendImpact()
    {
        return $this->container['trend_impact'];
    }

    /**
     * Sets trend_impact
     *
     * @param int $trend_impact The number of impressions gained or lost based on the rank change and the keyword's search volume. This reflects the impact of the rank change in the desktop Visibility metric.
     *
     * @return $this
     */
    public function setTrendImpact($trend_impact)
    {
        $this->container['trend_impact'] = $trend_impact;
     ...
     * Gets best_rank
     *
     * @return \Swagger\Client\Model\BestRank
     */
    public function getBestRank()
    {
        return $this->container['best_rank'];
    }

    /**
     * Sets best_rank
     *
     * @param \Swagger\Client\Model\BestRank $best_rank best_rank
     *
     * @return $this
     */
    public function setBestRank($best_rank)
    {
        $this->container['best_rank'] = $best_rank;
