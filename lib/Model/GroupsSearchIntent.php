...
/**
 * GroupsSearchIntent Class Doc Comment
 *
 * @category Class
 * @description Parent field containing the search intent breakdown of the group in percentages out of its total search volume
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupsSearchIntent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'groups-search-intent';
    ...
    {
        $this->container['informational'] = isset($data['informational']) ? $data['informational'] : null;
     ...
     * Sets informational
     *
     * @param double $informational The percentage of the search volume of keywords that have informational search intent.
     *
     * @return $this
     */
     ...
     * Sets commercial
     *
     * @param double $commercial The percentage of the search volume of keywords that have commercial search intent.
     *
     * @return $this
     */
     ...
     * Sets transactional
     *
     * @param double $transactional The percentage of the search volume of keywords that have transactional search intent.
     *
     * @return $this
     */
