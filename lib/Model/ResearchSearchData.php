...
/**
 * ResearchSearchData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResearchSearchData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'research-search-data';
     ...
     * Sets search_volume
     *
     * @param int $search_volume The average 12-month desktop search volume as provided by Google Ads.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\MonthlySearches $monthly_searches monthly_searches
     *
     * @return $this
     */
