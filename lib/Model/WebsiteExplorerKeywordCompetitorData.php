...
/**
 * WebsiteExplorerKeywordCompetitorData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WebsiteExplorerKeywordCompetitorData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'website-explorer-keyword-competitor-data';
    ...
    protected static $setters = [
        ...
        'rank' => 'setRank',
        'rank_change' => 'setRankChange',
        'rank_change_date' => 'setRankChangeDate'
    ];
    ...
    protected static $getters = [
        ...
        'rank' => 'getRank',
        'rank_change' => 'getRankChange',
        'rank_change_date' => 'getRankChangeDate'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rank_change'] = isset($data['rank_change']) ? $data['rank_change'] : null;
        $this->container['rank_change_date'] = isset($data['rank_change_date']) ? $data['rank_change_date'] : null;
    }
    ...
    {
        return $this->container['rank_change'];
    }

    /**
     * Sets rank_change
     *
     * @param int $rank_change Keyword rank change
     *
     * @return $this
     */
    public function setRankChange($rank_change)
    {
        $this->container['rank_change'] = $rank_change;

        return $this;
    }

    /**
     * Gets rank_change_date
     *
     * @return \DateTime
     */
    public function getRankChangeDate()
    {
        return $this->container['rank_change_date'];
    }

    /**
     * Sets rank_change_date
     *
     * @param \DateTime $rank_change_date Keyword rank change
     *
     * @return $this
     */
    public function setRankChangeDate($rank_change_date)
    {
        $this->container['rank_change_date'] = $rank_change_date;
