 ...
 *
 * @category Class
 * @description An object containing the data related to google search volumes.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SearchData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'search-data';
     ...
     * Sets year_over_year
     *
     * @param int $year_over_year A numeric value representing the last month's search volume divided by the search volume of the same month of the previous year. E.g. +49% year-over-year search trend would be represented as 1.49.  The returned values will be capped at 10, which represents \"newcomers\" (keywords that registered very low search volumes in the previous year).
     *
     * @return $this
     */
     ...
     * Sets search_volume
     *
     * @param int $search_volume The latest average 12-month search volume as provided by Google Ads.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\MonthlySearches[] $monthly_searches An array of objects containing the search volumes for each of the previous 13 months as provided by Google Ads.
     *
     * @return $this
     */
