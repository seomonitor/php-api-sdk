...
/**
 * KeywordVaultGetOverviewData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordVaultGetOverviewData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keyword-vault-get-overview-data';
    ...
    protected static $swaggerTypes = [
        ...
        'visibility_data' => '\Swagger\Client\Model\TopicOverviewVisibility'
    ];
    ...
    {
        $this->container['keyword_count'] = isset($data['keyword_count']) ? $data['keyword_count'] : null;
     ...
     * Sets keyword_count
     *
     * @param int $keyword_count The total number of curated keywords included in the list.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\TopicOverviewVisibility
     */
     ...
     *
     * @param \Swagger\Client\Model\TopicOverviewVisibility $visibility_data visibility_data
     *
     * @return $this
     */
