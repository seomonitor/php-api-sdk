...
/**
 * ResearchRankingData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResearchRankingData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'research-ranking-data';
     ...
     * Sets rank
     *
     * @param int $rank The position on Google at the latest crawl date refreshed within the past 30 days, for desktop devices.
     *
     * @return $this
     */
     ...
     * Sets trend
     *
     * @param int $trend The difference in positions on Google between the latest rank and the rank identified at the previous crawl, for desktop devices.
     *
     * @return $this
     */
     ...
     * Sets landing_page
     *
     * @param string $landing_page The landing page of your website that is currently ranking with the keyword on Google searches performed from desktop devices.
     *
     * @return $this
     */
