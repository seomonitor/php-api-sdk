...
/**
 * KeywordLandingPages Class Doc Comment
 *
 * @category Class
 * @description An object containing the landing pages that the keyword currently ranks for in a google search and the desired values (if any) that you have set in the app. If the keyword ranks outside top 100 the landing page value is the firs one that we found by searching site:yourdomain.com keyword.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordLandingPages implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keyword-landing-pages';
    ...
    protected static $swaggerTypes = [
        'desktop' => '\Swagger\Client\Model\LandingPages',
        'mobile' => '\Swagger\Client\Model\LandingPages'
    ];
     ...
     * Gets desktop
     *
     * @return \Swagger\Client\Model\LandingPages
     */
     ...
     * Sets desktop
     *
     * @param \Swagger\Client\Model\LandingPages $desktop desktop
     *
     * @return $this
     */
     ...
     * Sets mobile
     *
     * @param \Swagger\Client\Model\LandingPages $mobile mobile
     *
     * @return $this
     */
