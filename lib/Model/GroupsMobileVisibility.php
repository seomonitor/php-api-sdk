...
/**
 * GroupsMobileVisibility Class Doc Comment
 *
 * @category Class
 * @description Parent field containing the mobile Visibility of the website for all the keywords of the group and the change in their percentage.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupsMobileVisibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'groups-mobile-visibility';
     ...
     * Sets latest
     *
     * @param double $latest The overall mobile Visibility at the end of the specified timeframe.
     *
     * @return $this
     */
     ...
     * Sets trend
     *
     * @param double $trend Percentage change in mobile Visibility of the website for all the keywords in the group over the given timeframe.
     *
     * @return $this
     */
