...
/**
 * ForecastConfiguration Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastConfiguration implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-configuration';
    ...
    protected static $swaggerTypes = [
        ...
        'conversion_data' => '\Swagger\Client\Model\ForecastConfigConversionData'
    ];
    ...
    protected static $swaggerFormats = [
        ...
        'progression_speed' => null,
        'use_year_over_year' => null,
        'use_search_volume_by_device' => null,
        'use_long_tail_effect' => null,
        'use_percentage_clicks' => null,
    ...
    protected static $setters = [
        ...
        'extended_forecast' => 'setExtendedForecast',
        'target_rank_range' => 'setTargetRankRange',
        'progression_speed' => 'setProgressionSpeed',
        'use_year_over_year' => 'setUseYearOverYear',
        'use_search_volume_by_device' => 'setUseSearchVolumeByDevice',
        'use_long_tail_effect' => 'setUseLongTailEffect',
        'use_percentage_clicks' => 'setUsePercentageClicks',
        'conversion_data' => 'setConversionData'
    ];
    ...
    protected static $getters = [
        ...
        'extended_forecast' => 'getExtendedForecast',
        'target_rank_range' => 'getTargetRankRange',
        'progression_speed' => 'getProgressionSpeed',
        'use_year_over_year' => 'getUseYearOverYear',
        'use_search_volume_by_device' => 'getUseSearchVolumeByDevice',
        'use_long_tail_effect' => 'getUseLongTailEffect',
        'use_percentage_clicks' => 'getUsePercentageClicks',
        'conversion_data' => 'getConversionData'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['extended_forecast'] = isset($data['extended_forecast']) ? $data['extended_forecast'] : null;
        $this->container['target_rank_range'] = isset($data['target_rank_range']) ? $data['target_rank_range'] : null;
        $this->container['progression_speed'] = isset($data['progression_speed']) ? $data['progression_speed'] : null;
        $this->container['use_year_over_year'] = isset($data['use_year_over_year']) ? $data['use_year_over_year'] : null;
        $this->container['use_search_volume_by_device'] = isset($data['use_search_volume_by_device']) ? $data['use_search_volume_by_device'] : null;
        $this->container['use_long_tail_effect'] = isset($data['use_long_tail_effect']) ? $data['use_long_tail_effect'] : null;
        $this->container['use_percentage_clicks'] = isset($data['use_percentage_clicks']) ? $data['use_percentage_clicks'] : null;
        $this->container['conversion_data'] = isset($data['conversion_data']) ? $data['conversion_data'] : null;
    }
     ...
     * Sets timeframe
     *
     * @param string $timeframe The duration of the scenario in months.
     *
     * @return $this
     */
     ...
     * Sets start_month
     *
     * @param string $start_month The month and year when the scenario was set to start.
     *
     * @return $this
     */
    ...
    /**
     * Gets extended_forecast
     *
     * @return bool
     */
    public function getExtendedForecast()
    {
        return $this->container['extended_forecast'];
    }

    /**
     * Sets extended_forecast
     *
     * @param bool $extended_forecast Whether the projection includes the extended forecast timeframe and the results estimated for it.
     *
     * @return $this
     */
    public function setExtendedForecast($extended_forecast)
    {
        $this->container['extended_forecast'] = $extended_forecast;

        return $this;
    }

    /**
     * Gets target_rank_range
     *
     * @return bool
     */
    public function getTargetRankRange()
    {
        return $this->container['target_rank_range'];
    }

    /**
     * Sets target_rank_range
     *
     * @param bool $target_rank_range Whether the target rank range option is enabled for the Objective. If 'true', the estimated results of the forecast will be returned for both the lower (worst) and the higher (best) target.
     *
     * @return $this
     */
    public function setTargetRankRange($target_rank_range)
    {
        $this->container['target_rank_range'] = $target_rank_range;

        return $this;
    }

    /**
     * Gets progression_speed
     *
     * @return string
     */
    public function getProgressionSpeed()
    {
        return $this->container['progression_speed'];
    }

    /**
     * Sets progression_speed
     *
     * @param string $progression_speed The user-configured speed at which the average selected target rank will be reached.  Possible values are `conservative`, `mostly conservative`, `moderate`, `mostly moderate`, `optimistic`, `mostly optimistic`, and `custom`.
     *
     * @return $this
     */
    public function setProgressionSpeed($progression_speed)
    {
        $this->container['progression_speed'] = $progression_speed;

        return $this;
    }

    /**
     * Gets use_year_over_year
     *
     * @return bool
     */
    public function getUseYearOverYear()
    {
        return $this->container['use_year_over_year'];
    }

    /**
     * Sets use_year_over_year
     *
     * @param bool $use_year_over_year Whether the option to include the Year-over-Year search trends of the keywords in the forecast calculation is enabled.
     *
     * @return $this
     */
    public function setUseYearOverYear($use_year_over_year)
    {
        $this->container['use_year_over_year'] = $use_year_over_year;

        return $this;
    }

    /**
     * Gets use_search_volume_by_device
     *
     * @return bool
     */
    public function getUseSearchVolumeByDevice()
    {
        return $this->container['use_search_volume_by_device'];
    }

    /**
     * Sets use_search_volume_by_device
     *
     * @param bool $use_search_volume_by_device Whether the option to include the search volume for each device of the keywords in the forecast calculation is enabled.
     *
     * @return $this
     */
    public function setUseSearchVolumeByDevice($use_search_volume_by_device)
    {
        $this->container['use_search_volume_by_device'] = $use_search_volume_by_device;

        return $this;
    }

    /**
     * Gets use_long_tail_effect
     *
     * @return bool
     */
    public function getUseLongTailEffect()
    {
        return $this->container['use_long_tail_effect'];
    }

    /**
     * Sets use_long_tail_effect
     *
     * @param bool $use_long_tail_effect Whether the option to include the estimation of additional traffic generated by other keywords semantically related to the ones included in the forecast is enabled.
     *
     * @return $this
     */
    public function setUseLongTailEffect($use_long_tail_effect)
    {
        $this->container['use_long_tail_effect'] = $use_long_tail_effect;

        return $this;
    }

    /**
     * Gets use_percentage_clicks
     *
     * @return bool
     */
    public function getUsePercentageClicks()
    {
        return $this->container['use_percentage_clicks'];
    }

    /**
     * Sets use_percentage_clicks
     *
     * @param bool $use_percentage_clicks Whether the option to include the Percentage Clicks metric in the forecast calculation is enabled.
     *
     * @return $this
     */
    public function setUsePercentageClicks($use_percentage_clicks)
    {
        $this->container['use_percentage_clicks'] = $use_percentage_clicks;

        return $this;
    }

    /**
     * Gets conversion_data
     *
     * @return \Swagger\Client\Model\ForecastConfigConversionData
     */
    public function getConversionData()
    {
        return $this->container['conversion_data'];
    }

    /**
     * Sets conversion_data
     *
     * @param \Swagger\Client\Model\ForecastConfigConversionData $conversion_data conversion_data
     *
     * @return $this
     */
    public function setConversionData($conversion_data)
    {
        $this->container['conversion_data'] = $conversion_data;
