...
/**
 * TrafficEcommerce Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TrafficEcommerce implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'traffic-ecommerce';
     ...
     * Sets conversions
     *
     * @param int $conversions The sum of conversions uncovered through the (not provided) solution on the date within the selected timeframe.
     *
     * @return $this
     */
     ...
     * Sets revenue
     *
     * @param int $revenue The sum of ecommerce revenue uncovered through the (not provided) solution on the specified date within the selected timeframe.
     *
     * @return $this
     */
