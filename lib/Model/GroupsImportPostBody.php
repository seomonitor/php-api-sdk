...
/**
 * GroupsImportPostBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupsImportPostBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'groups-import-post-body';
     ...
     * Sets campaign_id
     *
     * @param int $campaign_id The campaign in which to import the folders and groups.
     *
     * @return $this
     */
     ...
     * Sets folders
     *
     * @param string $folders An array of folders and groups in which to be imported.
     *
     * @return $this
     */
     ...
     * Sets groups
     *
     * @param string $groups The groups to be added.
     *
     * @return $this
     */
