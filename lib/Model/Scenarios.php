 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Scenarios implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'scenarios';
    ...
    {
        $this->container['forecast_id'] = isset($data['forecast_id']) ? $data['forecast_id'] : null;
    ...
    {
        return $this->container['forecast_id'];
    }

    /**
     * Sets forecast_id
     *
     * @param int $forecast_id The ID of the Forecast scenario for which the data is returned.
     *
     * @return $this
     */
    public function setForecastId($forecast_id)
    {
        $this->container['forecast_id'] = $forecast_id;
     ...
     * Sets name
     *
     * @param string $name The name assigned to the scenario in the platform.
     *
     * @return $this
     */
     ...
     * Sets objective
     *
     * @param bool $objective Whether the Forecast scenario is set as the current Objective of the campaign.
     *
     * @return $this
     */
     ...
     * Sets created_date
     *
     * @param \DateTime $created_date The date when the scenario was created, in YYYY-MM-DD format.
     *
     * @return $this
     */
     ...
     * Sets created_by
     *
     * @param string $created_by The first and last name of the user who created the scenario.
     *
     * @return $this
     */
     ...
     * Sets updated_date
     *
     * @param string $updated_date The date when the last changes were made to the SEO goal and configuration of the scenario.
     *
     * @return $this
     */
     ...
     * Sets monthly_budget
     *
     * @param int $monthly_budget The monthly budget allocated to the scenario, in the campaign currency.
     *
     * @return $this
     */
