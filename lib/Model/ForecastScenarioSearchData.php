...
/**
 * ForecastScenarioSearchData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastScenarioSearchData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-scenario-search-data';
    ...
    protected static $swaggerTypes = [
        ...
        'monthly_searches' => '\Swagger\Client\Model\MonthlySearches[]',
        'volume_by_device' => '\Swagger\Client\Model\GroupsVolumeByDevice',
    ...
    protected static $setters = [
        ...
        'volume_by_device' => 'setVolumeByDevice',
    ...
    protected static $getters = [
        ...
        'volume_by_device' => 'getVolumeByDevice',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['monthly_searches'] = isset($data['monthly_searches']) ? $data['monthly_searches'] : null;
        $this->container['volume_by_device'] = isset($data['volume_by_device']) ? $data['volume_by_device'] : null;
     ...
     * Sets search_volume
     *
     * @param int $search_volume The average 12-month search volume of the keywords included in the scenario, as provided by Google Ads.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\MonthlySearches[]
     */
     ...
     *
     * @param \Swagger\Client\Model\MonthlySearches[] $monthly_searches An array of objects containing the average search volumes for each of the previous 13 months for the keywords included in the scenario, as provided by Google Ads.
     *
     * @return $this
     */
    ...
    /**
     * Gets volume_by_device
     *
     * @return \Swagger\Client\Model\GroupsVolumeByDevice
     */
    public function getVolumeByDevice()
    {
        return $this->container['volume_by_device'];
    }

    /**
     * Sets volume_by_device
     *
     * @param \Swagger\Client\Model\GroupsVolumeByDevice $volume_by_device volume_by_device
     *
     * @return $this
     */
    public function setVolumeByDevice($volume_by_device)
    {
        $this->container['volume_by_device'] = $volume_by_device;
