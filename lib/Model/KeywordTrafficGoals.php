...
/**
 * KeywordTrafficGoals Class Doc Comment
 *
 * @category Class
 * @description An object containing the information about goals aggregated as sums for the specific timeframe.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordTrafficGoals implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keyword-traffic-goals';
     ...
     * Sets revenue
     *
     * @param int $revenue Total goal revenue uncovered through the (not provided) solution for the selected goals within the selected timeframe.
     *
     * @return $this
     */
     ...
     * Sets completions
     *
     * @param int $completions Total goal completions within the selected timeframe.
     *
     * @return $this
     */
