...
/**
 * ForecastTrafficEstimatedAvgRanks Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastTrafficEstimatedAvgRanks implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-traffic-estimated_avg_ranks';
    ...
    protected static $setters = [
        'estimated_best_target' => 'setEstimatedBestTarget',
    ...
    protected static $getters = [
        'estimated_best_target' => 'getEstimatedBestTarget',
    ...
    {
        $this->container['estimated_best_target'] = isset($data['estimated_best_target']) ? $data['estimated_best_target'] : null;
    ...
    /**
     * Gets estimated_best_target
     *
     * @return int
     */
    public function getEstimatedBestTarget()
    {
        return $this->container['estimated_best_target'];
    }

    /**
     * Sets estimated_best_target
     *
     * @param int $estimated_best_target If the `target_rank_range` parameter returns \"true\", this parameter returns the value calculated for the higher (best) target rank.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty.
     *
     * @return $this
     */
    public function setEstimatedBestTarget($estimated_best_target)
    {
        $this->container['estimated_best_target'] = $estimated_best_target;
     ...
     * Sets estimated
     *
     * @param double $estimated The estimated average rank.  If the `target_rank_range` parameter returns \"true\", this is the value calculated for the lower (worst) target rank.
     *
     * @return $this
     */
