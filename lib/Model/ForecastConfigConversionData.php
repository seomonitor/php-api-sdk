...
/**
 * ForecastConfigConversionData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastConfigConversionData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-config-conversion-data';
     ...
     *
     * @param double $conversion_rate The average Conversion Rate of the keywords included in the forecast scenario, used in the calculation of the estimated Additional Conversions as the multiplier of Additional Sessions.
     *
     * @return $this
     */
     ...
     *
     * @param double $avg_order_value The Average Order Value of the keywords included in the forecast scenario, used in the calculation of the estimated Additional Revenue as the multiplier of Additional Conversions.
     *
     * @return $this
     */
