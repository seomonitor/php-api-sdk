...
/**
 * ResearchSerpFeature Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResearchSerpFeature implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'research-serp-feature';
     ...
     * Sets position
     *
     * @param int $position The position of the feature on the Google results page. It can be a number from 1 to 100 or \"side\" if the element is on the right-side panel (e.g., Knowledge Graph on desktop searches).
     *
     * @return $this
     */
