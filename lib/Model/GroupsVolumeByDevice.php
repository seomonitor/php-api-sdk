...
/**
 * GroupsVolumeByDevice Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupsVolumeByDevice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'groups-volume-by-device';
     ...
     * Sets desktop
     *
     * @param double $desktop The percentage from total searches that come from desktop devices.
     *
     * @return $this
     */
     ...
     * Sets mobile
     *
     * @param double $mobile The percentage from total searches that come from mobile devices.
     *
     * @return $this
     */
