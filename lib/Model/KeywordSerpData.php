...
/**
 * KeywordSerpData Class Doc Comment
 *
 * @category Class
 * @description An object containing the latest data about the SERP features present in the google searches from desktop and mobile devices.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordSerpData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keyword-serp-data';
    ...
    protected static $swaggerTypes = [
        'desktop' => '\Swagger\Client\Model\KeywordSerpFeature[]',
        'mobile' => '\Swagger\Client\Model\KeywordSerpFeature[]',
     ...
     * Gets desktop
     *
     * @return \Swagger\Client\Model\KeywordSerpFeature[]
     */
     ...
     * Sets desktop
     *
     * @param \Swagger\Client\Model\KeywordSerpFeature[] $desktop Parent field containing the SERP features data for desktop devices.
     *
     * @return $this
     */
     ...
     * Sets mobile
     *
     * @param \Swagger\Client\Model\KeywordSerpFeature[] $mobile Parent field containing the SERP features data for mobile devices.
     *
     * @return $this
     */
     ...
     *
     * @param float $percentage_clicks The percentage of searches that end up clicking on organic results, after discounting the searches satisfied by SERP features. Blended metric between desktop and mobile searches.
     *
     * @return $this
     */
