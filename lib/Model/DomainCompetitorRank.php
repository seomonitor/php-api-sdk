...
/**
 * DomainCompetitorRank Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DomainCompetitorRank implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'domain-competitor-rank';
     ...
     * Sets landing_page
     *
     * @param string $landing_page The landing page of the requested domain on URL that is currently ranking with the keyword on Google searches performed from desktop devices.
     *
     * @return $this
     */
