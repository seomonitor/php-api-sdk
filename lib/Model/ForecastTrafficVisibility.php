...
/**
 * ForecastTrafficVisibility Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastTrafficVisibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-traffic-visibility';
     ...
     * Sets estimated
     *
     * @param double $estimated The estimated Visibility.  If the `target_rank_range` parameter returns \"true\", this is the value calculated for the lower (worst) target rank.
     *
     * @return $this
     */
