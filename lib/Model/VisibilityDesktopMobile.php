...
/**
 * VisibilityDesktopMobile Class Doc Comment
 *
 * @category Class
 * @description The Visibility shows your campaign’s share of the total searches (impressions), out of the total potential it could get.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VisibilityDesktopMobile implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'visibility-desktop-mobile';
    ...
    protected static $setters = [
        'latest' => 'setLatest',
        'trend_7days' => 'setTrend7days',
        'trend_30days' => 'setTrend30days'
    ];
    ...
    protected static $getters = [
        'latest' => 'getLatest',
        'trend_7days' => 'getTrend7days',
        'trend_30days' => 'getTrend30days'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['trend_7days'] = isset($data['trend_7days']) ? $data['trend_7days'] : null;
        $this->container['trend_30days'] = isset($data['trend_30days']) ? $data['trend_30days'] : null;
    }
     ...
     * Sets latest
     *
     * @param double $latest The group of keyword's share of the total searches (impressions) , out of the total potential it could get. It is measured in percentages, from 0% (outside Top 20 on all keywords) to 100% (ranking 1st on all keywords) taking into account the desktop positions.
     *
     * @return $this
     */
    ...
    {
        return $this->container['trend_7days'];
    }

    /**
     * Sets trend_7days
     *
     * @param float $trend_7days The group of keyword's share of the total searches (impressions) , out of the total potential it could get. It is measured in percentages, from 0% (outside Top 20 on all keywords) to 100% (ranking 1st on all keywords) taking into account the mobile positions.
     *
     * @return $this
     */
    public function setTrend7days($trend_7days)
    {
        $this->container['trend_7days'] = $trend_7days;
    ...
    {
        return $this->container['trend_30days'];
    }

    /**
     * Sets trend_30days
     *
     * @param float $trend_30days The change in desktop Visibility over the past 30 days, as a numeric value between 0-100.
     *
     * @return $this
     */
    public function setTrend30days($trend_30days)
    {
        $this->container['trend_30days'] = $trend_30days;
