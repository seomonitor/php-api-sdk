...
/**
 * TrafficGoals Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TrafficGoals implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'traffic-goals';
     ...
     * Sets completions
     *
     * @param int $completions The total number of goal completions uncovered through the (not provided) solution for the selected goals for the date within the selected timeframe.
     *
     * @return $this
     */
     ...
     * Sets revenue
     *
     * @param int $revenue The goal revenue uncovered through the (not provided) solution for the selected goals on the date within the selected timeframe.
     *
     * @return $this
     */
