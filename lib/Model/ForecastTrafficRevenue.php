...
/**
 * ForecastTrafficRevenue Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastTrafficRevenue implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-traffic-revenue';
     ...
     * Sets inertial
     *
     * @param int $inertial The number of inertial revenue.
     *
     * @return $this
     */
     ...
     * Sets additional
     *
     * @param int $additional The value of additional revenue, in the campaign currency.  If the `target_rank_range` parameter returns \"true\", this is the value calculated for the lower (worst) target rank.
     *
     * @return $this
     */
