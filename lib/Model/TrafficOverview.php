...
/**
 * TrafficOverview Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TrafficOverview implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'traffic-overview';
    ...
    protected static $swaggerTypes = [
        'date' => '\DateTime',
        'sessions' => 'int',
        'ecommerce' => '\Swagger\Client\Model\TrafficEcommerce',
        'goals' => '\Swagger\Client\Model\TrafficGoals',
        'bounce_rate' => 'float'
    ];
     ...
     * Sets date
     *
     * @param \DateTime $date The date for which the traffic data is being returned, in YYYY-MM-DD format.
     *
     * @return $this
     */
     ...
     * Sets sessions
     *
     * @param int $sessions The sum of sessions for the specified traffic segment, if the campaign is connected to both Google Search Console and Google Analytics – or clicks, if the campaign is only connected to Google Search Console, on the date within the selected timeframe.
     *
     * @return $this
     */
     ...
     * Gets ecommerce
     *
     * @return \Swagger\Client\Model\TrafficEcommerce
     */
     ...
     * Sets ecommerce
     *
     * @param \Swagger\Client\Model\TrafficEcommerce $ecommerce ecommerce
     *
     * @return $this
     */
     ...
     * Gets goals
     *
     * @return \Swagger\Client\Model\TrafficGoals
     */
     ...
     * Sets goals
     *
     * @param \Swagger\Client\Model\TrafficGoals $goals goals
     *
     * @return $this
     */
     ...
     * Sets bounce_rate
     *
     * @param float $bounce_rate The percentage of single-page sessions for the website segment on the specified date.
     *
     * @return $this
     */
