...
/**
 * GroupDailyVisibility Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupDailyVisibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'group-daily-visibility';
    ...
    protected static $swaggerTypes = [
        'date' => '\DateTime',
        'visibility' => '\Swagger\Client\Model\GroupsVisibility',
        'avg_rank' => '\Swagger\Client\Model\GroupsAvgRank',
        'feature_visibility' => '\Swagger\Client\Model\GroupsFeatureVisibility'
    ];
    ...
    protected static $setters = [
        ...
        'avg_rank' => 'setAvgRank',
        'feature_visibility' => 'setFeatureVisibility'
    ];
    ...
    protected static $getters = [
        ...
        'avg_rank' => 'getAvgRank',
        'feature_visibility' => 'getFeatureVisibility'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['avg_rank'] = isset($data['avg_rank']) ? $data['avg_rank'] : null;
        $this->container['feature_visibility'] = isset($data['feature_visibility']) ? $data['feature_visibility'] : null;
    }
     ...
     * Sets date
     *
     * @param \DateTime $date The date within the requested timeframe for which Visibility metrics are returned.
     *
     * @return $this
     */
     ...
     * Gets visibility
     *
     * @return \Swagger\Client\Model\GroupsVisibility
     */
     ...
     * Sets visibility
     *
     * @param \Swagger\Client\Model\GroupsVisibility $visibility visibility
     *
     * @return $this
     */
     ...
     * Gets avg_rank
     *
     * @return \Swagger\Client\Model\GroupsAvgRank
     */
    public function getAvgRank()
    {
        return $this->container['avg_rank'];
    }

    /**
     * Sets avg_rank
     *
     * @param \Swagger\Client\Model\GroupsAvgRank $avg_rank avg_rank
     *
     * @return $this
     */
    public function setAvgRank($avg_rank)
    {
        $this->container['avg_rank'] = $avg_rank;

        return $this;
    }

    /**
     * Gets feature_visibility
     *
     * @return \Swagger\Client\Model\GroupsFeatureVisibility
     */
    public function getFeatureVisibility()
    {
        return $this->container['feature_visibility'];
    }

    /**
     * Sets feature_visibility
     *
     * @param \Swagger\Client\Model\GroupsFeatureVisibility $feature_visibility feature_visibility
     *
     * @return $this
     */
    public function setFeatureVisibility($feature_visibility)
    {
        $this->container['feature_visibility'] = $feature_visibility;
