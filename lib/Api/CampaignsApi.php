...
class CampaignsApi
{
     ...
     * @param  int $limit The maximum number of Tracked Campaigns to return data for.   Maximum Value: 100 records per request  If you do not specify a &#x60;limit&#x60;, the default number of records returned per request will be 10. (optional)
     ...
     * @return \Swagger\Client\Model\CampaignDetailsRegular[]
     */
    public function dashboardV30CampaignsTrackedGet($campaign_ids = null, $company_id = null, $limit = null, $offset = null)
    {
        list($response) = $this->dashboardV30CampaignsTrackedGetWithHttpInfo($campaign_ids, $company_id, $limit, $offset);
        return $response;
    }

    /**
     * Operation dashboardV30CampaignsTrackedGetWithHttpInfo
     *
     * Get Tracked Campaigns
     *
     * @param  string $campaign_ids The Tracked Campaigns IDs for which you want the data to be returned.  Please refer to the Quick Start Guide to learn how to retrieve your campaign IDs.  If you do not specify &#x60;campaign_ids&#x60;, the endpoint will return the data for all active Tracked Campaigns you have access to, across all company accounts. (optional)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\CampaignDetailsRegular[], HTTP status code, HTTP response headers (array of strings)
     */
    public function dashboardV30CampaignsTrackedGetWithHttpInfo($campaign_ids = null, $company_id = null, $limit = null, $offset = null)
    {
        $returnType = '\Swagger\Client\Model\CampaignDetailsRegular[]';
        $request = $this->dashboardV30CampaignsTrackedGetRequest($campaign_ids, $company_id, $limit, $offset);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\CampaignDetailsRegular[]',
    ...
    /**
     * Operation dashboardV30CampaignsTrackedGetAsync
     *
     * Get Tracked Campaigns
     *
     * @param  string $campaign_ids The Tracked Campaigns IDs for which you want the data to be returned.  Please refer to the Quick Start Guide to learn how to retrieve your campaign IDs.  If you do not specify &#x60;campaign_ids&#x60;, the endpoint will return the data for all active Tracked Campaigns you have access to, across all company accounts. (optional)
     ...
     */
    public function dashboardV30CampaignsTrackedGetAsync($campaign_ids = null, $company_id = null, $limit = null, $offset = null)
    {
        return $this->dashboardV30CampaignsTrackedGetAsyncWithHttpInfo($campaign_ids, $company_id, $limit, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation dashboardV30CampaignsTrackedGetAsyncWithHttpInfo
     *
     * Get Tracked Campaigns
     *
     * @param  string $campaign_ids The Tracked Campaigns IDs for which you want the data to be returned.  Please refer to the Quick Start Guide to learn how to retrieve your campaign IDs.  If you do not specify &#x60;campaign_ids&#x60;, the endpoint will return the data for all active Tracked Campaigns you have access to, across all company accounts. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dashboardV30CampaignsTrackedGetAsyncWithHttpInfo($campaign_ids = null, $company_id = null, $limit = null, $offset = null)
    {
        $returnType = '\Swagger\Client\Model\CampaignDetailsRegular[]';
        $request = $this->dashboardV30CampaignsTrackedGetRequest($campaign_ids, $company_id, $limit, $offset);
    ...
    /**
     * Create request for operation 'dashboardV30CampaignsTrackedGet'
     *
     * @param  string $campaign_ids The Tracked Campaigns IDs for which you want the data to be returned.  Please refer to the Quick Start Guide to learn how to retrieve your campaign IDs.  If you do not specify &#x60;campaign_ids&#x60;, the endpoint will return the data for all active Tracked Campaigns you have access to, across all company accounts. (optional)
     * @param  int $company_id The ID of the subscription that contains the Tracked Campaigns for which you want to return data. This is useful for users who have access to multiple company accounts.  Please refer to the Quick Start Guide to learn how to retrieve your company IDs.  If you don&#x27;t specify a &#x60;company_id&#x60;, the endpoint will return the data for all Tracked Campaigns you have access to, across all company accounts. (optional)
     * @param  int $limit The maximum number of Tracked Campaigns to return data for.   Maximum Value: 100 records per request  If you do not specify a &#x60;limit&#x60;, the default number of records returned per request will be 10. (optional)
     ...
     */
    protected function dashboardV30CampaignsTrackedGetRequest($campaign_ids = null, $company_id = null, $limit = null, $offset = null)
    {

        $resourcePath = '/dashboard/v3.0/campaigns/tracked';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($campaign_ids !== null) {
            $queryParams['campaign_ids'] = ObjectSerializer::toQueryValue($campaign_ids, null);
        }
        // query params
        if ($company_id !== null) {
