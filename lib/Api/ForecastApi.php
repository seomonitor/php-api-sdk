...
class ForecastApi
{
    ...
    /**
     * Operation forecastV30KeywordsGet
     *
     ...
     * @return \Swagger\Client\Model\ForecastKeywords[]
     */
    public function forecastV30KeywordsGet($campaign_id, $forecast_id, $limit = null, $offset = null)
    {
        list($response) = $this->forecastV30KeywordsGetWithHttpInfo($campaign_id, $forecast_id, $limit, $offset);
        return $response;
    }

    /**
     * Operation forecastV30KeywordsGetWithHttpInfo
     *
     * Get Forecast keywords
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ForecastKeywords[], HTTP status code, HTTP response headers (array of strings)
     */
    public function forecastV30KeywordsGetWithHttpInfo($campaign_id, $forecast_id, $limit = null, $offset = null)
    {
        $returnType = '\Swagger\Client\Model\ForecastKeywords[]';
        $request = $this->forecastV30KeywordsGetRequest($campaign_id, $forecast_id, $limit, $offset);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ForecastKeywords[]',
    ...
    /**
     * Operation forecastV30KeywordsGetAsync
     *
     * Get Forecast keywords
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     ...
     */
    public function forecastV30KeywordsGetAsync($campaign_id, $forecast_id, $limit = null, $offset = null)
    {
        return $this->forecastV30KeywordsGetAsyncWithHttpInfo($campaign_id, $forecast_id, $limit, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation forecastV30KeywordsGetAsyncWithHttpInfo
     *
     * Get Forecast keywords
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function forecastV30KeywordsGetAsyncWithHttpInfo($campaign_id, $forecast_id, $limit = null, $offset = null)
    {
        $returnType = '\Swagger\Client\Model\ForecastKeywords[]';
        $request = $this->forecastV30KeywordsGetRequest($campaign_id, $forecast_id, $limit, $offset);
    ...
    /**
     * Create request for operation 'forecastV30KeywordsGet'
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param  int $forecast_id This parameter specifies the ID of the Forecast scenario set as an Objective for which you want to return data.   Please refer to the &#x27;Quick Start Guide&#x27;  to retrieve the ID of your scenarios. (required)
     * @param  int $limit This parameter determines the maximum number of records to return in a single request.   Maximum Value: 1000 records per request   If you do not specify a &#x60;limit&#x60;, the default number of records returned per request will be 100. (optional)
     ...
     */
    protected function forecastV30KeywordsGetRequest($campaign_id, $forecast_id, $limit = null, $offset = null)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling forecastV30KeywordsGet'
            );
        }
        // verify the required parameter 'forecast_id' is set
        if ($forecast_id === null || (is_array($forecast_id) && count($forecast_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $forecast_id when calling forecastV30KeywordsGet'
            );
        }

        $resourcePath = '/forecast/v3.0/keywords';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($forecast_id !== null) {
            $queryParams['forecast_id'] = ObjectSerializer::toQueryValue($forecast_id, null);
        }
        // query params
        if ($limit !== null) {
    ...
    /**
     * Operation forecastV30ObjectiveGet
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ForecastObjectiveData
     */
    public function forecastV30ObjectiveGet($campaign_id, $forecast_id)
    {
        list($response) = $this->forecastV30ObjectiveGetWithHttpInfo($campaign_id, $forecast_id);
        return $response;
    }

    /**
     * Operation forecastV30ObjectiveGetWithHttpInfo
     *
     * Get Forecast objective Data
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ForecastObjectiveData, HTTP status code, HTTP response headers (array of strings)
     */
    public function forecastV30ObjectiveGetWithHttpInfo($campaign_id, $forecast_id)
    {
        $returnType = '\Swagger\Client\Model\ForecastObjectiveData';
        $request = $this->forecastV30ObjectiveGetRequest($campaign_id, $forecast_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ForecastObjectiveData',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation forecastV30ObjectiveGetAsync
     *
     * Get Forecast objective Data
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function forecastV30ObjectiveGetAsync($campaign_id, $forecast_id)
    {
        return $this->forecastV30ObjectiveGetAsyncWithHttpInfo($campaign_id, $forecast_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation forecastV30ObjectiveGetAsyncWithHttpInfo
     *
     * Get Forecast objective Data
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function forecastV30ObjectiveGetAsyncWithHttpInfo($campaign_id, $forecast_id)
    {
        $returnType = '\Swagger\Client\Model\ForecastObjectiveData';
        $request = $this->forecastV30ObjectiveGetRequest($campaign_id, $forecast_id);
    ...
    /**
     * Create request for operation 'forecastV30ObjectiveGet'
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param  int $forecast_id This parameter specifies the ID of the Forecast scenario for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your Forecast scenarios. (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function forecastV30ObjectiveGetRequest($campaign_id, $forecast_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling forecastV30ObjectiveGet'
            );
        }
        // verify the required parameter 'forecast_id' is set
        if ($forecast_id === null || (is_array($forecast_id) && count($forecast_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $forecast_id when calling forecastV30ObjectiveGet'
            );
        }

        $resourcePath = '/forecast/v3.0/objective';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation forecastV30ScenarioGet
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ForecastScenarioData
     */
    public function forecastV30ScenarioGet($campaign_id, $forecast_id)
    {
        list($response) = $this->forecastV30ScenarioGetWithHttpInfo($campaign_id, $forecast_id);
        return $response;
    }

    /**
     * Operation forecastV30ScenarioGetWithHttpInfo
     *
     * Get Forecast scenario Data
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ForecastScenarioData, HTTP status code, HTTP response headers (array of strings)
     */
    public function forecastV30ScenarioGetWithHttpInfo($campaign_id, $forecast_id)
    {
        $returnType = '\Swagger\Client\Model\ForecastScenarioData';
        $request = $this->forecastV30ScenarioGetRequest($campaign_id, $forecast_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ForecastScenarioData',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation forecastV30ScenarioGetAsync
     *
     * Get Forecast scenario Data
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function forecastV30ScenarioGetAsync($campaign_id, $forecast_id)
    {
        return $this->forecastV30ScenarioGetAsyncWithHttpInfo($campaign_id, $forecast_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation forecastV30ScenarioGetAsyncWithHttpInfo
     *
     * Get Forecast scenario Data
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function forecastV30ScenarioGetAsyncWithHttpInfo($campaign_id, $forecast_id)
    {
        $returnType = '\Swagger\Client\Model\ForecastScenarioData';
        $request = $this->forecastV30ScenarioGetRequest($campaign_id, $forecast_id);
    ...
    /**
     * Create request for operation 'forecastV30ScenarioGet'
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param  int $forecast_id This parameter specifies the ID of the Forecast scenario for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your Forecast scenarios.  To get data for the Campaign Objective, use the &#x27;Get Forecast Objective Data&#x27;. (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function forecastV30ScenarioGetRequest($campaign_id, $forecast_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling forecastV30ScenarioGet'
            );
        }
        // verify the required parameter 'forecast_id' is set
        if ($forecast_id === null || (is_array($forecast_id) && count($forecast_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $forecast_id when calling forecastV30ScenarioGet'
            );
        }

        $resourcePath = '/forecast/v3.0/scenario';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation forecastV30ScenariosGet
     *
     ...
     */
    public function forecastV30ScenariosGet($campaign_id)
    {
        list($response) = $this->forecastV30ScenariosGetWithHttpInfo($campaign_id);
        return $response;
    }

    /**
     * Operation forecastV30ScenariosGetWithHttpInfo
     *
     * Get Forecast scenarios
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Scenarios, HTTP status code, HTTP response headers (array of strings)
     */
    public function forecastV30ScenariosGetWithHttpInfo($campaign_id)
    {
        $returnType = '\Swagger\Client\Model\Scenarios';
        $request = $this->forecastV30ScenariosGetRequest($campaign_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\Scenarios',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation forecastV30ScenariosGetAsync
     *
     * Get Forecast scenarios
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function forecastV30ScenariosGetAsync($campaign_id)
    {
        return $this->forecastV30ScenariosGetAsyncWithHttpInfo($campaign_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation forecastV30ScenariosGetAsyncWithHttpInfo
     *
     * Get Forecast scenarios
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function forecastV30ScenariosGetAsyncWithHttpInfo($campaign_id)
    {
        $returnType = '\Swagger\Client\Model\Scenarios';
        $request = $this->forecastV30ScenariosGetRequest($campaign_id);
    ...
    /**
     * Create request for operation 'forecastV30ScenariosGet'
     *
     * @param  int $campaign_id This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function forecastV30ScenariosGetRequest($campaign_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling forecastV30ScenariosGet'
            );
        }

        $resourcePath = '/forecast/v3.0/scenarios';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
