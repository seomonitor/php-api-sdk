...
/**
 * TrafficKeywords Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TrafficKeywords implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'traffic-keywords';
    ...
    protected static $swaggerTypes = [
        ...
        'brand' => 'bool',
        'current_page' => 'string',
        'gsc_data' => '\Swagger\Client\Model\GscData',
        'analytics_data' => '\Swagger\Client\Model\AnalyticsData'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['gsc_data'] = isset($data['gsc_data']) ? $data['gsc_data'] : null;
     ...
     * Sets keyword
     *
     * @param string $keyword The exact keyword phrase for which traffic data is returned.
     *
     * @return $this
     */
     ...
     * Sets brand
     *
     * @param bool $brand Whether the keyword is a brand name.
     *
     * @return $this
     */
     ...
     * Sets current_page
     *
     * @param string $current_page The current landing page that ranks for the keyword, irrespective of the specified timeframe.
     *
     * @return $this
     */
     ...
     * Gets gsc_data
     *
     * @return \Swagger\Client\Model\GscData
     */
    public function getGscData()
    {
        return $this->container['gsc_data'];
    }

    /**
     * Sets gsc_data
     *
     * @param \Swagger\Client\Model\GscData $gsc_data gsc_data
     *
     * @return $this
     */
    public function setGscData($gsc_data)
    {
        $this->container['gsc_data'] = $gsc_data;
     ...
     * Gets analytics_data
     *
     * @return \Swagger\Client\Model\AnalyticsData
     */
     ...
     * Sets analytics_data
     *
     * @param \Swagger\Client\Model\AnalyticsData $analytics_data analytics_data
     *
     * @return $this
     */
