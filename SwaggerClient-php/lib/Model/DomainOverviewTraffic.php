...
/**
 * DomainOverviewTraffic Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DomainOverviewTraffic implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'domain-overview-traffic';
    ...
    protected static $swaggerTypes = [
        'my_traffic' => '\Swagger\Client\Model\OverviewTrafficData',
        'competitor_traffic' => '\Swagger\Client\Model\OverviewTrafficData'
    ];
    ...
    protected static $setters = [
        'my_traffic' => 'setMyTraffic',
        'competitor_traffic' => 'setCompetitorTraffic'
    ];
    ...
    protected static $getters = [
        'my_traffic' => 'getMyTraffic',
        'competitor_traffic' => 'getCompetitorTraffic'
    ];
    ...
    {
        $this->container['my_traffic'] = isset($data['my_traffic']) ? $data['my_traffic'] : null;
        $this->container['competitor_traffic'] = isset($data['competitor_traffic']) ? $data['competitor_traffic'] : null;
    }
     ...
     * Gets my_traffic
     *
     * @return \Swagger\Client\Model\OverviewTrafficData
     */
    public function getMyTraffic()
    {
        return $this->container['my_traffic'];
    }

    /**
     * Sets my_traffic
     *
     * @param \Swagger\Client\Model\OverviewTrafficData $my_traffic my_traffic
     *
     * @return $this
     */
    public function setMyTraffic($my_traffic)
    {
        $this->container['my_traffic'] = $my_traffic;

        return $this;
    }

    /**
     * Gets competitor_traffic
     *
     * @return \Swagger\Client\Model\OverviewTrafficData
     */
    public function getCompetitorTraffic()
    {
        return $this->container['competitor_traffic'];
    }

    /**
     * Sets competitor_traffic
     *
     * @param \Swagger\Client\Model\OverviewTrafficData $competitor_traffic competitor_traffic
     *
     * @return $this
     */
    public function setCompetitorTraffic($competitor_traffic)
    {
        $this->container['competitor_traffic'] = $competitor_traffic;
