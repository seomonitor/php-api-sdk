...
/**
 * ForecastKeywordAvgRank Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ForecastKeywordAvgRank implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'forecast-keyword-avg-rank';
    ...
    protected static $swaggerFormats = [
        ...
        'actual_rank' => null,
        'estimated_rank' => null,
        'estimated_rank_best_target' => null,
        'target_rank' => null,
        'target_rank_best' => null
    ];
    ...
    protected static $setters = [
        'initial_rank' => 'setInitialRank',
        'actual_rank' => 'setActualRank',
        'estimated_rank' => 'setEstimatedRank',
        'estimated_rank_best_target' => 'setEstimatedRankBestTarget',
        'target_rank' => 'setTargetRank',
        'target_rank_best' => 'setTargetRankBest'
    ];
    ...
    protected static $getters = [
        'initial_rank' => 'getInitialRank',
        'actual_rank' => 'getActualRank',
        'estimated_rank' => 'getEstimatedRank',
        'estimated_rank_best_target' => 'getEstimatedRankBestTarget',
        'target_rank' => 'getTargetRank',
        'target_rank_best' => 'getTargetRankBest'
    ];
    ...
    {
        $this->container['initial_rank'] = isset($data['initial_rank']) ? $data['initial_rank'] : null;
        $this->container['actual_rank'] = isset($data['actual_rank']) ? $data['actual_rank'] : null;
        $this->container['estimated_rank'] = isset($data['estimated_rank']) ? $data['estimated_rank'] : null;
        $this->container['estimated_rank_best_target'] = isset($data['estimated_rank_best_target']) ? $data['estimated_rank_best_target'] : null;
        $this->container['target_rank'] = isset($data['target_rank']) ? $data['target_rank'] : null;
        $this->container['target_rank_best'] = isset($data['target_rank_best']) ? $data['target_rank_best'] : null;
    }
    ...
    {
        return $this->container['initial_rank'];
    }

    /**
     * Sets initial_rank
     *
     * @param int $initial_rank The initial rank of the keyword for the month when the scenario was created.
     *
     * @return $this
     */
    public function setInitialRank($initial_rank)
    {
        $this->container['initial_rank'] = $initial_rank;
     ...
     * @return int
     */
    public function getActualRank()
    {
        return $this->container['actual_rank'];
    }

    /**
     * Sets actual_rank
     *
     * @param int $actual_rank The latest rank of the keyword on the day the data is returned. Returns empty if the scenario is not set as an Objective.
     *
     * @return $this
     */
    public function setActualRank($actual_rank)
    {
        $this->container['actual_rank'] = $actual_rank;
    ...
    {
        return $this->container['estimated_rank'];
    }

    /**
     * Sets estimated_rank
     *
     * @param int $estimated_rank The estimated rank of the keyword for the month when the data is returned. If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.
     *
     * @return $this
     */
    public function setEstimatedRank($estimated_rank)
    {
        $this->container['estimated_rank'] = $estimated_rank;

        return $this;
    }

    /**
     * Gets estimated_rank_best_target
     *
     * @return int
     */
    public function getEstimatedRankBestTarget()
    {
        return $this->container['estimated_rank_best_target'];
    }

    /**
     * Sets estimated_rank_best_target
     *
     * @param int $estimated_rank_best_target If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.
     *
     * @return $this
     */
    public function setEstimatedRankBestTarget($estimated_rank_best_target)
    {
        $this->container['estimated_rank_best_target'] = $estimated_rank_best_target;
    ...
    {
        return $this->container['target_rank'];
    }

    /**
     * Sets target_rank
     *
     * @param int $target_rank The targetted rank of the keyword for the last month of the timeframe. If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.
     *
     * @return $this
     */
    public function setTargetRank($target_rank)
    {
        $this->container['target_rank'] = $target_rank;

        return $this;
    }

    /**
     * Gets target_rank_best
     *
     * @return int
     */
    public function getTargetRankBest()
    {
        return $this->container['target_rank_best'];
    }

    /**
     * Sets target_rank_best
     *
     * @param int $target_rank_best If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.
     *
     * @return $this
     */
    public function setTargetRankBest($target_rank_best)
    {
        $this->container['target_rank_best'] = $target_rank_best;
