...
/**
 * KeywordResearchRankingData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordResearchRankingData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keyword-research-ranking-data';
    ...
    protected static $swaggerTypes = [
        'keyword' => 'string',
        'updated_on' => 'string',
        'ranking_data' => '\Swagger\Client\Model\ResearchDomainRanking'
    ];
     ...
     * Sets updated_on
     *
     * @param string $updated_on The date when the latest crawl was performed, in YYYY-MM-DD format.
     *
     * @return $this
     */
     ...
     * Gets ranking_data
     *
     * @return \Swagger\Client\Model\ResearchDomainRanking
     */
     ...
     * Sets ranking_data
     *
     * @param \Swagger\Client\Model\ResearchDomainRanking $ranking_data ranking_data
     *
     * @return $this
     */
