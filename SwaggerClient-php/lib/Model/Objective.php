 ...
 *
 * @category Class
 * @description Details about the current objective (if any) set for the campaign.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Objective implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'estimated_sessions' => 'setEstimatedSessions',
    ...
    protected static $getters = [
        ...
        'estimated_sessions' => 'getEstimatedSessions',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['estimated_sessions'] = isset($data['estimated_sessions']) ? $data['estimated_sessions'] : null;
     ...
     * Sets status
     *
     * @param string $status The status of the Objective, based on the campaign performance.  Possible values: `on_track`, `behind`, `at_risk`.
     *
     * @return $this
     */
     ...
     *
     * @param double $actual_sessions The non-brand organic traffic sessions recorded in the past 30 days.
     *
     * @return $this
     */
    ...
    /**
     * Gets estimated_sessions
     *
     * @return int
     */
    public function getEstimatedSessions()
    {
        return $this->container['estimated_sessions'];
    }

    /**
     * Sets estimated_sessions
     *
     * @param int $estimated_sessions The non-brand organic traffic sessions estimated to be obtained in the past 30 days, based on the SEO goal set up in the Forecast Objective.
     *
     * @return $this
     */
    public function setEstimatedSessions($estimated_sessions)
    {
        $this->container['estimated_sessions'] = $estimated_sessions;
     ...
     * Sets performance
     *
     * @param float $performance The campaign's traffic performance over the past 30 days, calculated by dividing the actual non-brand organic traffic by the estimated traffic in the last 30 days.
     *
     * @return $this
     */
     ...
     * Sets start_month
     *
     * @param string $start_month The first month of the forecast scenario that was set as an Objective.
     *
     * @return $this
     */
     ...
     * Sets end_month
     *
     * @param string $end_month The last month of the forecast scenario that was set as an Objective.
     *
     * @return $this
     */
