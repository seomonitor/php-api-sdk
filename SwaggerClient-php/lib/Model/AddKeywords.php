 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddKeywords implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'add-keywords';
     ...
     * Sets import_id
     *
     * @param string $import_id The ID of the keyword import task that you can use to track the status of the import. 
     *
     * @return $this
     */
