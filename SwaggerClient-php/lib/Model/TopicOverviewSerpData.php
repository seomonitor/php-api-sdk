...
/**
 * TopicOverviewSerpData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TopicOverviewSerpData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'topic-overview-serp-data';
    ...
    protected static $swaggerTypes = [
        ...
        'serp_features' => '\Swagger\Client\Model\TopicOverviewSerpFeature[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['serp_features'] = isset($data['serp_features']) ? $data['serp_features'] : null;
    }
     ...
     *
     * @param int $percentage_clicks The percentage of searches that end up clicking on organic results, based on the sum of Top 10 positions' CTRs after discounting the searches satisfied by SERP features.
     *
     * @return $this
     */
     ...
     * Gets serp_features
     *
     * @return \Swagger\Client\Model\TopicOverviewSerpFeature[]
     */
    public function getSerpFeatures()
    {
        return $this->container['serp_features'];
    }

    /**
     * Sets serp_features
     *
     * @param \Swagger\Client\Model\TopicOverviewSerpFeature[] $serp_features Parent field containing the top 10 SERP features present for the returned keywords and their presence count for the day of the latest crawl refreshed within the past 30 days, for desktop searches.  Please refer to the Quick Start Guide for the complete feature name of each abbreviation.
     *
     * @return $this
     */
    public function setSerpFeatures($serp_features)
    {
        $this->container['serp_features'] = $serp_features;
