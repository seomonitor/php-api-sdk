...
/**
 * CampaignDetailsRegular Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CampaignDetailsRegular implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'campaign-details-regular';
    ...
    protected static $swaggerTypes = [
        'campaign_info' => '\Swagger\Client\Model\CampaignInfo',
        'visibility' => '\Swagger\Client\Model\CampaignVisibility',
        'multiple_locations' => 'null[]',
        'health_status' => 'string',
        'objective_status' => '\Swagger\Client\Model\Objective',
    ...
    protected static $setters = [
        'campaign_info' => 'setCampaignInfo',
        'visibility' => 'setVisibility',
        'multiple_locations' => 'setMultipleLocations',
        'health_status' => 'setHealthStatus',
        'objective_status' => 'setObjectiveStatus',
    ...
    protected static $getters = [
        ...
        'multiple_locations' => 'getMultipleLocations',
        'health_status' => 'getHealthStatus',
        'objective_status' => 'getObjectiveStatus',
    ...
    {
        $this->container['campaign_info'] = isset($data['campaign_info']) ? $data['campaign_info'] : null;
        $this->container['visibility'] = isset($data['visibility']) ? $data['visibility'] : null;
        $this->container['multiple_locations'] = isset($data['multiple_locations']) ? $data['multiple_locations'] : null;
        $this->container['health_status'] = isset($data['health_status']) ? $data['health_status'] : null;
        $this->container['objective_status'] = isset($data['objective_status']) ? $data['objective_status'] : null;
        $this->container['reporting_status'] = isset($data['reporting_status']) ? $data['reporting_status'] : null;
     ...
     * Gets campaign_info
     *
     * @return \Swagger\Client\Model\CampaignInfo
     */
    public function getCampaignInfo()
    {
        return $this->container['campaign_info'];
    }

    /**
     * Sets campaign_info
     *
     * @param \Swagger\Client\Model\CampaignInfo $campaign_info campaign_info
     *
     * @return $this
     */
    public function setCampaignInfo($campaign_info)
    {
        $this->container['campaign_info'] = $campaign_info;
     ...
     * Gets visibility
     *
     * @return \Swagger\Client\Model\CampaignVisibility
     */
     ...
     * Sets visibility
     *
     * @param \Swagger\Client\Model\CampaignVisibility $visibility visibility
     *
     * @return $this
     */
    ...
    /**
     * Gets multiple_locations
     *
     * @return null[]
     */
    public function getMultipleLocations()
    {
        return $this->container['multiple_locations'];
    }

    /**
     * Sets multiple_locations
     *
     * @param null[] $multiple_locations Parent field containing data for the additional tracked locations of the campaign.
     *
     * @return $this
     */
    public function setMultipleLocations($multiple_locations)
    {
        $this->container['multiple_locations'] = $multiple_locations;
     ...
     * Sets health_status
     *
     * @param string $health_status The health status of the campaign.  Possible values: `poor`, `average`, `healthy`.
     *
     * @return $this
     */
    ...
    /**
     * Gets objective_status
     *
     * @return \Swagger\Client\Model\Objective
     */
    public function getObjectiveStatus()
    {
        return $this->container['objective_status'];
    }

    /**
     * Sets objective_status
     *
     * @param \Swagger\Client\Model\Objective $objective_status objective_status
     *
     * @return $this
     */
    public function setObjectiveStatus($objective_status)
    {
        $this->container['objective_status'] = $objective_status;
     ...
     *
     * @param string $reporting_status The reporting status for the current month.  Possible values:   `pending`: The default status of the report at the beginning of the month.  `overdue`: If the report is not submitted by the due date set.  `in_progress`: If someone started working on the report in Google Slides.  `submitted`: If the report has been uploaded or finalized in Google Slides.  `inactive`: If the report tracking is turned off for the campaign.
     *
     * @return $this
     */
     ...
     *
     * @param string $account_manager The first and last name of the user assigned as the Account Manager of the campaign.
     *
     * @return $this
     */
