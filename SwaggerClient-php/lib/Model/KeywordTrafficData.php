...
/**
 * KeywordTrafficData Class Doc Comment
 *
 * @category Class
 * @description An object containing the traffic metrics aggregated as sums in the selected timeframe.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KeywordTrafficData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'keyword-traffic-data';
    ...
    protected static $swaggerTypes = [
        'currency' => 'string',
        'ecommerce' => '\Swagger\Client\Model\KeywordTrafficEcommerce',
        'goals' => '\Swagger\Client\Model\KeywordTrafficGoals',
        'sessions' => 'int'
    ];
     ...
     * Sets currency
     *
     * @param string $currency The currency for the revenue metrics in the eccomerce and goals objects.
     *
     * @return $this
     */
     ...
     * Gets ecommerce
     *
     * @return \Swagger\Client\Model\KeywordTrafficEcommerce
     */
     ...
     * Sets ecommerce
     *
     * @param \Swagger\Client\Model\KeywordTrafficEcommerce $ecommerce ecommerce
     *
     * @return $this
     */
     ...
     * Gets goals
     *
     * @return \Swagger\Client\Model\KeywordTrafficGoals
     */
     ...
     * Sets goals
     *
     * @param \Swagger\Client\Model\KeywordTrafficGoals $goals goals
     *
     * @return $this
     */
     ...
     * Sets sessions
     *
     * @param int $sessions The sum of sessions, if the campaign is connected to both Google Search Console and Google Analytics – or clicks, if the campaign is only connected to Google Search Console, within the selected timeframe.
     *
     * @return $this
     */
